...
public class CreatePlaylistRequest {
    ...
    public CreatePlaylistRequest(@JsonProperty("title") String title, @JsonProperty("type") QueryParamType type, @JsonProperty("smart") Smart smart, @JsonProperty("uri") String uri) {
        this.title = title;
        this.type = type;
        this.smart = smart;
        this.uri = uri;
