...
public class GetButlerTasksResponse {
    ...
    public GetButlerTasksResponse withStatusCode(Integer statusCode) {
    ...
    public GetButlerTasksResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
    ...
    public GetButlerTasksResponseBody twoHundredApplicationJsonObject;
    ...
    public GetButlerTasksButlerResponseBody fourHundredAndOneApplicationJsonObject;
    ...
    public GetButlerTasksResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode, @JsonProperty("RawResponse") HttpResponse<byte[]> rawResponse) {
        this.contentType = contentType;
        this.statusCode = statusCode;
        this.rawResponse = rawResponse;
  }
