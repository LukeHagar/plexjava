...
public class TranscodeSession {
    ...
    public TranscodeSession withSize(Double size) {
        this.size = size;
        return this;
    }
    ...
    public TranscodeSession withDuration(Double duration) {
    ...
    public TranscodeSession withAudioChannels(Double audioChannels) {
