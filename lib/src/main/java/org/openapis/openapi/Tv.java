...
public class Tv {
	...
	public Tv(SDKConfiguration sdkConfiguration) {
     ...
     * @param xPlexClientIdentifier Plex Authentication Token
    ...
    public org.openapis.openapi.models.operations.GetPinResponse getPin(String xPlexClientIdentifier, Boolean strong, String serverURL) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.GetPinPlexTvResponseBody out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.GetPinPlexTvResponseBody.class);
