...
public class Library {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.SearchLibraryResponse searchLibrary(Long sectionId, org.openapis.openapi.models.operations.Type type) throws Exception {
        org.openapis.openapi.models.operations.SearchLibraryRequest request = new org.openapis.openapi.models.operations.SearchLibraryRequest(sectionId, type);
        
        String baseUrl = org.openapis.openapi.utils.Utils.templateUrl(this.sdkConfiguration.serverUrl, this.sdkConfiguration.getServerVariableDefaults());
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.SearchLibraryRequest.class, baseUrl, "/library/sections/{sectionId}/search", request, null);
        ...
        req.addHeader("Accept", "application/json");
        req.addHeader("user-agent", this.sdkConfiguration.userAgent);
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.SearchLibraryRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
        ...
        org.openapis.openapi.models.operations.SearchLibraryResponse res = new org.openapis.openapi.models.operations.SearchLibraryResponse(contentType, httpRes.statusCode(), httpRes) {{
            object = null;
        }};
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.SearchLibraryResponseBody out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.SearchLibraryResponseBody.class);
                res.object = out;
            }
        }
