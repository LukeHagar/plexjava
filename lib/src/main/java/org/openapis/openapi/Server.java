...
public class Server {
    ...
    public org.openapis.openapi.models.operations.GetAvailableClientsResponse getAvailableClients() throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.GetAvailableClientsServerResponseBody out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.GetAvailableClientsServerResponseBody.class);
                res.fourHundredAndOneApplicationJsonObject = out;
            }
        }
