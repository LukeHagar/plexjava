...
public class Playlists {
    ...
    public org.openapis.openapi.models.operations.CreatePlaylistResponse createPlaylist(org.openapis.openapi.models.operations.CreatePlaylistRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.CreatePlaylistPlaylistsResponseBody out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.CreatePlaylistPlaylistsResponseBody.class);
    ...
    public org.openapis.openapi.models.operations.GetPlaylistsResponse getPlaylists(org.openapis.openapi.models.operations.PlaylistType playlistType, org.openapis.openapi.models.operations.QueryParamSmart smart) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.GetPlaylistsPlaylistsResponseBody out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.GetPlaylistsPlaylistsResponseBody.class);
                res.fourHundredAndOneApplicationJsonObject = out;
            }
        }
    ...
    public org.openapis.openapi.models.operations.GetPlaylistResponse getPlaylist(Double playlistID) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.GetPlaylistPlaylistsResponseBody out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.GetPlaylistPlaylistsResponseBody.class);
                res.fourHundredAndOneApplicationJsonObject = out;
            }
        }
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.UpdatePlaylistResponse updatePlaylist(Double playlistID, String title) throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.UpdatePlaylistResponse updatePlaylist(Double playlistID, String title, String summary) throws Exception {
        ...
        req.addHeader("Accept", "application/json");
        req.addHeader("user-agent", this.sdkConfiguration.userAgent);
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.UpdatePlaylistRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
    ...
    public org.openapis.openapi.models.operations.GetPlaylistContentsResponse getPlaylistContents(Double playlistID, Double type) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.GetPlaylistContentsPlaylistsResponseBody out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.GetPlaylistContentsPlaylistsResponseBody.class);
                res.fourHundredAndOneApplicationJsonObject = out;
            }
        }
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.AddPlaylistContentsResponse addPlaylistContents(Double playlistID, String uri) throws Exception {
    ...
    public org.openapis.openapi.models.operations.AddPlaylistContentsResponse addPlaylistContents(Double playlistID, String uri, Double playQueueID) throws Exception {
        org.openapis.openapi.models.operations.AddPlaylistContentsRequest request = new org.openapis.openapi.models.operations.AddPlaylistContentsRequest(playlistID, uri);
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.AddPlaylistContentsPlaylistsResponseBody out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.AddPlaylistContentsPlaylistsResponseBody.class);
                res.fourHundredAndOneApplicationJsonObject = out;
            }
        }
