...
public class GetBandwidthStatisticsAccount {
    ...
    public GetBandwidthStatisticsAccount withId(Optional<? extends Integer> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
    ...
    public GetBandwidthStatisticsAccount withKey(Optional<? extends String> key) {
        Utils.checkNotNull(key, "key");
        this.key = key;
        return this;
    }
    ...
    public GetBandwidthStatisticsAccount withName(Optional<? extends String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
    ...
    public GetBandwidthStatisticsAccount withDefaultAudioLanguage(Optional<? extends String> defaultAudioLanguage) {
        Utils.checkNotNull(defaultAudioLanguage, "defaultAudioLanguage");
        this.defaultAudioLanguage = defaultAudioLanguage;
        return this;
    }
    ...
    public GetBandwidthStatisticsAccount withAutoSelectAudio(Optional<? extends Boolean> autoSelectAudio) {
        Utils.checkNotNull(autoSelectAudio, "autoSelectAudio");
        this.autoSelectAudio = autoSelectAudio;
        return this;
    }
    ...
    public GetBandwidthStatisticsAccount withDefaultSubtitleLanguage(Optional<? extends String> defaultSubtitleLanguage) {
        Utils.checkNotNull(defaultSubtitleLanguage, "defaultSubtitleLanguage");
        this.defaultSubtitleLanguage = defaultSubtitleLanguage;
        return this;
    }
    ...
    public GetBandwidthStatisticsAccount withSubtitleMode(Optional<? extends Integer> subtitleMode) {
        Utils.checkNotNull(subtitleMode, "subtitleMode");
        this.subtitleMode = subtitleMode;
        return this;
    }
    ...
    public GetBandwidthStatisticsAccount withThumb(Optional<? extends String> thumb) {
        Utils.checkNotNull(thumb, "thumb");
        this.thumb = thumb;
        return this;
    }
