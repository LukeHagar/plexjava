...
public class GetLibraryLibraryResponseBody {
    ...
    public GetLibraryLibraryResponseBody withErrors(java.util.List<GetLibraryErrors> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = Optional.ofNullable(errors);
        return this;
    }

    public GetLibraryLibraryResponseBody withErrors(Optional<? extends java.util.List<GetLibraryErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetLibraryLibraryResponseBody other = (GetLibraryLibraryResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetLibraryLibraryResponseBody.class,
                "errors", errors);
    }
    ...
    public final static class Builder {
        ...
        public GetLibraryLibraryResponseBody build() {
            return new GetLibraryLibraryResponseBody(
                errors);
        }
    }
}
