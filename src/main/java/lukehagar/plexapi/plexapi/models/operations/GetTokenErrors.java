...
public class GetTokenErrors {
    ...
    public GetTokenErrors withCode(Optional<? extends Double> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
    ...
    public GetTokenErrors withMessage(Optional<? extends String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
    ...
    public GetTokenErrors withStatus(Optional<? extends Double> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetTokenErrors other = (GetTokenErrors) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetTokenErrors.class,
                "code", code,
                "message", message,
                "status", status);
    }
    ...
    public final static class Builder {
        ...
        public GetTokenErrors build() {
            return new GetTokenErrors(
                code,
                message,
                status);
        }
