...
public class GetTopWatchedContentGenre {
    ...
    public GetTopWatchedContentGenre withId(Optional<? extends Integer> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
    ...
    public GetTopWatchedContentGenre withFilter(Optional<? extends String> filter) {
        Utils.checkNotNull(filter, "filter");
        this.filter = filter;
        return this;
    }
    ...
    public GetTopWatchedContentGenre withTag(Optional<? extends String> tag) {
        Utils.checkNotNull(tag, "tag");
        this.tag = tag;
        return this;
    }
