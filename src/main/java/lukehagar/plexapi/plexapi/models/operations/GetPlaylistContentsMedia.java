...
public class GetPlaylistContentsMedia {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("Part")
    private Optional<? extends java.util.List<GetPlaylistContentsPart>> part;
    ...
    public GetPlaylistContentsMedia(
            ...
            @JsonProperty("Part") Optional<? extends java.util.List<GetPlaylistContentsPart>> part) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<java.util.List<GetPlaylistContentsPart>> part() {
        return (Optional<java.util.List<GetPlaylistContentsPart>>) part;
    }
    ...
    public GetPlaylistContentsMedia withId(Optional<? extends Integer> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
    ...
    public GetPlaylistContentsMedia withDuration(Optional<? extends Integer> duration) {
        Utils.checkNotNull(duration, "duration");
        this.duration = duration;
        return this;
    }
    ...
    public GetPlaylistContentsMedia withBitrate(Optional<? extends Integer> bitrate) {
        Utils.checkNotNull(bitrate, "bitrate");
        this.bitrate = bitrate;
        return this;
    }
    ...
    public GetPlaylistContentsMedia withWidth(Optional<? extends Integer> width) {
        Utils.checkNotNull(width, "width");
        this.width = width;
        return this;
    }
    ...
    public GetPlaylistContentsMedia withHeight(Optional<? extends Integer> height) {
        Utils.checkNotNull(height, "height");
        this.height = height;
        return this;
    }
    ...
    public GetPlaylistContentsMedia withAspectRatio(Optional<? extends Double> aspectRatio) {
        Utils.checkNotNull(aspectRatio, "aspectRatio");
        this.aspectRatio = aspectRatio;
        return this;
    }
    ...
    public GetPlaylistContentsMedia withAudioChannels(Optional<? extends Integer> audioChannels) {
        Utils.checkNotNull(audioChannels, "audioChannels");
        this.audioChannels = audioChannels;
        return this;
    }
    ...
    public GetPlaylistContentsMedia withAudioCodec(Optional<? extends String> audioCodec) {
        Utils.checkNotNull(audioCodec, "audioCodec");
        this.audioCodec = audioCodec;
        return this;
    }
    ...
    public GetPlaylistContentsMedia withVideoCodec(Optional<? extends String> videoCodec) {
        Utils.checkNotNull(videoCodec, "videoCodec");
        this.videoCodec = videoCodec;
        return this;
    }
    ...
    public GetPlaylistContentsMedia withVideoResolution(Optional<? extends String> videoResolution) {
        Utils.checkNotNull(videoResolution, "videoResolution");
        this.videoResolution = videoResolution;
        return this;
    }
    ...
    public GetPlaylistContentsMedia withContainer(Optional<? extends String> container) {
        Utils.checkNotNull(container, "container");
        this.container = container;
        return this;
    }
    ...
    public GetPlaylistContentsMedia withVideoFrameRate(Optional<? extends String> videoFrameRate) {
        Utils.checkNotNull(videoFrameRate, "videoFrameRate");
        this.videoFrameRate = videoFrameRate;
        return this;
    }
    ...
    public GetPlaylistContentsMedia withOptimizedForStreaming(Optional<? extends Integer> optimizedForStreaming) {
        Utils.checkNotNull(optimizedForStreaming, "optimizedForStreaming");
        this.optimizedForStreaming = optimizedForStreaming;
        return this;
    }
    ...
    public GetPlaylistContentsMedia withAudioProfile(Optional<? extends String> audioProfile) {
        Utils.checkNotNull(audioProfile, "audioProfile");
        this.audioProfile = audioProfile;
        return this;
    }
    ...
    public GetPlaylistContentsMedia withHas64bitOffsets(Optional<? extends Boolean> has64bitOffsets) {
        Utils.checkNotNull(has64bitOffsets, "has64bitOffsets");
        this.has64bitOffsets = has64bitOffsets;
        return this;
    }
    ...
    public GetPlaylistContentsMedia withVideoProfile(Optional<? extends String> videoProfile) {
        Utils.checkNotNull(videoProfile, "videoProfile");
        this.videoProfile = videoProfile;
        return this;
    }

    public GetPlaylistContentsMedia withPart(java.util.List<GetPlaylistContentsPart> part) {
        Utils.checkNotNull(part, "part");
        this.part = Optional.ofNullable(part);
        return this;
    }

    public GetPlaylistContentsMedia withPart(Optional<? extends java.util.List<GetPlaylistContentsPart>> part) {
        Utils.checkNotNull(part, "part");
        this.part = part;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends java.util.List<GetPlaylistContentsPart>> part = Optional.empty();  
        ...
        public Builder part(java.util.List<GetPlaylistContentsPart> part) {
            Utils.checkNotNull(part, "part");
            this.part = Optional.ofNullable(part);
            return this;
        }

        public Builder part(Optional<? extends java.util.List<GetPlaylistContentsPart>> part) {
            Utils.checkNotNull(part, "part");
            this.part = part;
            return this;
        }
