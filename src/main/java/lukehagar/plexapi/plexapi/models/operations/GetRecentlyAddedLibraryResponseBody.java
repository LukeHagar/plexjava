...
public class GetRecentlyAddedLibraryResponseBody {
    ...
    public GetRecentlyAddedLibraryResponseBody withErrors(java.util.List<GetRecentlyAddedErrors> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = Optional.ofNullable(errors);
        return this;
    }

    public GetRecentlyAddedLibraryResponseBody withErrors(Optional<? extends java.util.List<GetRecentlyAddedErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
