...
public class GetDevicesServerResponseBody {
    ...
    public GetDevicesServerResponseBody(
    ...
    public GetDevicesServerResponseBody withErrors(java.util.List<GetDevicesErrors> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = Optional.ofNullable(errors);
        return this;
    }

    public GetDevicesServerResponseBody withErrors(Optional<? extends java.util.List<GetDevicesErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetDevicesServerResponseBody other = (GetDevicesServerResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetDevicesServerResponseBody.class,
                "errors", errors);
    }
    ...
    public final static class Builder {
        ...
        public GetDevicesServerResponseBody build() {
            return new GetDevicesServerResponseBody(
                errors);
        }
    }
}
