...
public class GetPlaylistContentsPlaylistsResponseBody {
    ...
    public GetPlaylistContentsPlaylistsResponseBody withErrors(java.util.List<GetPlaylistContentsErrors> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = Optional.ofNullable(errors);
        return this;
    }

    public GetPlaylistContentsPlaylistsResponseBody withErrors(Optional<? extends java.util.List<GetPlaylistContentsErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetPlaylistContentsPlaylistsResponseBody other = (GetPlaylistContentsPlaylistsResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetPlaylistContentsPlaylistsResponseBody.class,
                "errors", errors);
    }
    ...
    public final static class Builder {
        ...
        public GetPlaylistContentsPlaylistsResponseBody build() {
            return new GetPlaylistContentsPlaylistsResponseBody(
                errors);
        }
    }
}
