...
public class GetLibraryHubsHubsResponseBody {
    ...
    public GetLibraryHubsHubsResponseBody withErrors(java.util.List<GetLibraryHubsErrors> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = Optional.ofNullable(errors);
        return this;
    }

    public GetLibraryHubsHubsResponseBody withErrors(Optional<? extends java.util.List<GetLibraryHubsErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetLibraryHubsHubsResponseBody other = (GetLibraryHubsHubsResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetLibraryHubsHubsResponseBody.class,
                "errors", errors);
    }
    ...
    public final static class Builder {
        ...
        public GetLibraryHubsHubsResponseBody build() {
            return new GetLibraryHubsHubsResponseBody(
                errors);
        }
    }
}
