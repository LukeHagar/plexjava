...
public class GetMetadataChildrenMediaContainer {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<java.util.List<GetMetadataChildrenDirectory>> directory() {
        return (Optional<java.util.List<GetMetadataChildrenDirectory>>) directory;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<java.util.List<GetMetadataChildrenMetadata>> metadata() {
        return (Optional<java.util.List<GetMetadataChildrenMetadata>>) metadata;
    }
