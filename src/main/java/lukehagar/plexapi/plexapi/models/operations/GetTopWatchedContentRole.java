...
public class GetTopWatchedContentRole {
    ...
    public GetTopWatchedContentRole withId(Optional<? extends Integer> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
    ...
    public GetTopWatchedContentRole withFilter(Optional<? extends String> filter) {
        Utils.checkNotNull(filter, "filter");
        this.filter = filter;
        return this;
    }
    ...
    public GetTopWatchedContentRole withTag(Optional<? extends String> tag) {
        Utils.checkNotNull(tag, "tag");
        this.tag = tag;
        return this;
    }
    ...
    public GetTopWatchedContentRole withTagKey(Optional<? extends String> tagKey) {
        Utils.checkNotNull(tagKey, "tagKey");
        this.tagKey = tagKey;
        return this;
    }
    ...
    public GetTopWatchedContentRole withRole(Optional<? extends String> role) {
        Utils.checkNotNull(role, "role");
        this.role = role;
        return this;
    }
    ...
    public GetTopWatchedContentRole withThumb(Optional<? extends String> thumb) {
        Utils.checkNotNull(thumb, "thumb");
        this.thumb = thumb;
        return this;
    }
