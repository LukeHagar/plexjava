...
public class GetSourceConnectionInformationResponseBody {
    ...
    public GetSourceConnectionInformationResponseBody withErrors(java.util.List<GetSourceConnectionInformationErrors> errors) {
        Utils.checkNotNull(errors, "errors");
    ...
    public final static class Builder {
        ...
        public Builder errors(java.util.List<GetSourceConnectionInformationErrors> errors) {
            Utils.checkNotNull(errors, "errors");
            this.errors = Optional.ofNullable(errors);
            return this;
        }
