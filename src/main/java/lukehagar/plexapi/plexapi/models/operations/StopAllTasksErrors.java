...
public class StopAllTasksErrors {
    ...
    public StopAllTasksErrors withCode(Optional<? extends Double> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
    ...
    public StopAllTasksErrors withMessage(Optional<? extends String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
    ...
    public StopAllTasksErrors withStatus(Optional<? extends Double> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        StopAllTasksErrors other = (StopAllTasksErrors) o;
        return 
    ...
    public String toString() {
        return Utils.toString(StopAllTasksErrors.class,
                "code", code,
                "message", message,
                "status", status);
    }
    ...
    public final static class Builder {
        ...
        public StopAllTasksErrors build() {
            return new StopAllTasksErrors(
                code,
                message,
                status);
        }
