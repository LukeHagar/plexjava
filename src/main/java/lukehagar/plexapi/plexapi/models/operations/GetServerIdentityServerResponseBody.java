...
public class GetServerIdentityServerResponseBody {
    ...
    public GetServerIdentityServerResponseBody(
    ...
    public GetServerIdentityServerResponseBody withErrors(java.util.List<GetServerIdentityErrors> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = Optional.ofNullable(errors);
        return this;
    }

    public GetServerIdentityServerResponseBody withErrors(Optional<? extends java.util.List<GetServerIdentityErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetServerIdentityServerResponseBody other = (GetServerIdentityServerResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetServerIdentityServerResponseBody.class,
                "errors", errors);
    }
    ...
    public final static class Builder {
        ...
        public GetServerIdentityServerResponseBody build() {
