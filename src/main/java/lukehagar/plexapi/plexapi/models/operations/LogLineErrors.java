...
public class LogLineErrors {
    ...
    public LogLineErrors withCode(Optional<? extends Double> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
    ...
    public LogLineErrors withMessage(Optional<? extends String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
    ...
    public LogLineErrors withStatus(Optional<? extends Double> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        LogLineErrors other = (LogLineErrors) o;
        return 
    ...
    public String toString() {
        return Utils.toString(LogLineErrors.class,
                "code", code,
                "message", message,
                "status", status);
    }
    ...
    public final static class Builder {
        ...
        public LogLineErrors build() {
            return new LogLineErrors(
                code,
                message,
                status);
        }
