...
public class GetPlaylistPlaylistsResponseBody {
    ...
    public GetPlaylistPlaylistsResponseBody withErrors(java.util.List<GetPlaylistErrors> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = Optional.ofNullable(errors);
        return this;
    }

    public GetPlaylistPlaylistsResponseBody withErrors(Optional<? extends java.util.List<GetPlaylistErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetPlaylistPlaylistsResponseBody other = (GetPlaylistPlaylistsResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetPlaylistPlaylistsResponseBody.class,
                "errors", errors);
    }
    ...
    public final static class Builder {
        ...
        public GetPlaylistPlaylistsResponseBody build() {
            return new GetPlaylistPlaylistsResponseBody(
                errors);
        }
    }
}
