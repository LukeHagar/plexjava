...
public class GetMyPlexAccountServerResponseBody {
    ...
    public GetMyPlexAccountServerResponseBody withErrors(java.util.List<GetMyPlexAccountErrors> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = Optional.ofNullable(errors);
        return this;
    }

    public GetMyPlexAccountServerResponseBody withErrors(Optional<? extends java.util.List<GetMyPlexAccountErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetMyPlexAccountServerResponseBody other = (GetMyPlexAccountServerResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetMyPlexAccountServerResponseBody.class,
                "errors", errors);
    }
    ...
    public final static class Builder {
        ...
        public GetMyPlexAccountServerResponseBody build() {
            return new GetMyPlexAccountServerResponseBody(
                errors);
        }
    }
}
