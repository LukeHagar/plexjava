...
public class GetMetadataChildrenLibraryResponseBody {
    ...
    public GetMetadataChildrenLibraryResponseBody withErrors(java.util.List<GetMetadataChildrenErrors> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = Optional.ofNullable(errors);
        return this;
    }

    public GetMetadataChildrenLibraryResponseBody withErrors(Optional<? extends java.util.List<GetMetadataChildrenErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetMetadataChildrenLibraryResponseBody other = (GetMetadataChildrenLibraryResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetMetadataChildrenLibraryResponseBody.class,
                "errors", errors);
    }
    ...
    public final static class Builder {
        ...
        public GetMetadataChildrenLibraryResponseBody build() {
            return new GetMetadataChildrenLibraryResponseBody(
                errors);
        }
    }
}
