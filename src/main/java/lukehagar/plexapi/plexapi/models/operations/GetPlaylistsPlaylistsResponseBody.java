...
public class GetPlaylistsPlaylistsResponseBody {
    ...
    public GetPlaylistsPlaylistsResponseBody withErrors(java.util.List<GetPlaylistsErrors> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = Optional.ofNullable(errors);
        return this;
    }

    public GetPlaylistsPlaylistsResponseBody withErrors(Optional<? extends java.util.List<GetPlaylistsErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetPlaylistsPlaylistsResponseBody other = (GetPlaylistsPlaylistsResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetPlaylistsPlaylistsResponseBody.class,
                "errors", errors);
    }
    ...
    public final static class Builder {
        ...
        public GetPlaylistsPlaylistsResponseBody build() {
            return new GetPlaylistsPlaylistsResponseBody(
                errors);
        }
    }
}
