...
public class GetServerCapabilitiesServerResponseBody {
    ...
    public GetServerCapabilitiesServerResponseBody withErrors(java.util.List<Errors> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = Optional.ofNullable(errors);
        return this;
    }

    public GetServerCapabilitiesServerResponseBody withErrors(Optional<? extends java.util.List<Errors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetServerCapabilitiesServerResponseBody other = (GetServerCapabilitiesServerResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetServerCapabilitiesServerResponseBody.class,
                "errors", errors);
    }
    ...
    public final static class Builder {
        ...
        public GetServerCapabilitiesServerResponseBody build() {
            return new GetServerCapabilitiesServerResponseBody(
                errors);
        }
    }
}
