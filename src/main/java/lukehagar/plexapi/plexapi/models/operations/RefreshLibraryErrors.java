...
public class RefreshLibraryErrors {
    ...
    public RefreshLibraryErrors withCode(Optional<? extends Double> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
    ...
    public RefreshLibraryErrors withMessage(Optional<? extends String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
    ...
    public RefreshLibraryErrors withStatus(Optional<? extends Double> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RefreshLibraryErrors other = (RefreshLibraryErrors) o;
        return 
    ...
    public String toString() {
        return Utils.toString(RefreshLibraryErrors.class,
                "code", code,
                "message", message,
                "status", status);
    }
    ...
    public final static class Builder {
        ...
        public RefreshLibraryErrors build() {
            return new RefreshLibraryErrors(
                code,
                message,
                status);
        }
