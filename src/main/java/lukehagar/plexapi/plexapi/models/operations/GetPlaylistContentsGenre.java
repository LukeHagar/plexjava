...
public class GetPlaylistContentsGenre {
    ...
    public GetPlaylistContentsGenre withTag(Optional<? extends String> tag) {
        Utils.checkNotNull(tag, "tag");
        this.tag = tag;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetPlaylistContentsGenre other = (GetPlaylistContentsGenre) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetPlaylistContentsGenre.class,
                "tag", tag);
    }
    ...
    public final static class Builder {
        ...
        public GetPlaylistContentsGenre build() {
            return new GetPlaylistContentsGenre(
                tag);
        }
    }
}
