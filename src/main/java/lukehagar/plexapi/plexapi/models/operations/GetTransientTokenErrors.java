...
public class GetTransientTokenErrors {
    ...
    public GetTransientTokenErrors(
    ...
    public GetTransientTokenErrors withCode(double code) {
        Utils.checkNotNull(code, "code");
        this.code = Optional.ofNullable(code);
        return this;
    }

    public GetTransientTokenErrors withCode(Optional<? extends Double> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }

    public GetTransientTokenErrors withMessage(String message) {
        Utils.checkNotNull(message, "message");
        this.message = Optional.ofNullable(message);
        return this;
    }

    public GetTransientTokenErrors withMessage(Optional<? extends String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }

    public GetTransientTokenErrors withStatus(double status) {
        Utils.checkNotNull(status, "status");
        this.status = Optional.ofNullable(status);
        return this;
    }

    public GetTransientTokenErrors withStatus(Optional<? extends Double> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetTransientTokenErrors other = (GetTransientTokenErrors) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetTransientTokenErrors.class,
                "code", code,
                "message", message,
                "status", status);
    }
    ...
    public final static class Builder {
        ...
        public GetTransientTokenErrors build() {
            return new GetTransientTokenErrors(
                code,
                message,
                status);
        }
