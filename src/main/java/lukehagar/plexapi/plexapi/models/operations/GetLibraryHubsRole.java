...
public class GetLibraryHubsRole {
    ...
    public GetLibraryHubsRole withTag(String tag) {
        Utils.checkNotNull(tag, "tag");
        this.tag = Optional.ofNullable(tag);
        return this;
    }

    public GetLibraryHubsRole withTag(Optional<? extends String> tag) {
        Utils.checkNotNull(tag, "tag");
        this.tag = tag;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetLibraryHubsRole other = (GetLibraryHubsRole) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetLibraryHubsRole.class,
                "tag", tag);
    }
    ...
    public final static class Builder {
        ...
        public GetLibraryHubsRole build() {
            return new GetLibraryHubsRole(
                tag);
        }
    }
}
