...
public class GetServerActivitiesActivitiesResponseBody {
    ...
    public GetServerActivitiesActivitiesResponseBody withErrors(java.util.List<GetServerActivitiesErrors> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = Optional.ofNullable(errors);
        return this;
    }

    public GetServerActivitiesActivitiesResponseBody withErrors(Optional<? extends java.util.List<GetServerActivitiesErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetServerActivitiesActivitiesResponseBody other = (GetServerActivitiesActivitiesResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetServerActivitiesActivitiesResponseBody.class,
                "errors", errors);
    }
    ...
    public final static class Builder {
        ...
        public GetServerActivitiesActivitiesResponseBody build() {
