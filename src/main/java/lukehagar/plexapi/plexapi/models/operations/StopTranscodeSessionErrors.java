...
public class StopTranscodeSessionErrors {
    ...
    public StopTranscodeSessionErrors(
    ...
    public StopTranscodeSessionErrors withCode(double code) {
        Utils.checkNotNull(code, "code");
        this.code = Optional.ofNullable(code);
        return this;
    }

    public StopTranscodeSessionErrors withCode(Optional<? extends Double> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }

    public StopTranscodeSessionErrors withMessage(String message) {
        Utils.checkNotNull(message, "message");
        this.message = Optional.ofNullable(message);
        return this;
    }

    public StopTranscodeSessionErrors withMessage(Optional<? extends String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }

    public StopTranscodeSessionErrors withStatus(double status) {
        Utils.checkNotNull(status, "status");
        this.status = Optional.ofNullable(status);
        return this;
    }

    public StopTranscodeSessionErrors withStatus(Optional<? extends Double> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        StopTranscodeSessionErrors other = (StopTranscodeSessionErrors) o;
        return 
    ...
    public String toString() {
        return Utils.toString(StopTranscodeSessionErrors.class,
                "code", code,
                "message", message,
                "status", status);
    }
    ...
    public final static class Builder {
        ...
        public StopTranscodeSessionErrors build() {
            return new StopTranscodeSessionErrors(
                code,
                message,
                status);
        }
