...
public class GetOnDeckLibraryResponseBody {
    ...
    public GetOnDeckLibraryResponseBody(
    ...
    public GetOnDeckLibraryResponseBody withErrors(java.util.List<GetOnDeckErrors> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = Optional.ofNullable(errors);
        return this;
    }

    public GetOnDeckLibraryResponseBody withErrors(Optional<? extends java.util.List<GetOnDeckErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetOnDeckLibraryResponseBody other = (GetOnDeckLibraryResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetOnDeckLibraryResponseBody.class,
                "errors", errors);
    }
    ...
    public final static class Builder {
        ...
        public GetOnDeckLibraryResponseBody build() {
            return new GetOnDeckLibraryResponseBody(
                errors);
        }
    }
}
