...
public class GetPlaylistContentsPart {
    ...
    public GetPlaylistContentsPart withId(Optional<? extends Integer> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
    ...
    public GetPlaylistContentsPart withKey(Optional<? extends String> key) {
        Utils.checkNotNull(key, "key");
        this.key = key;
        return this;
    }
    ...
    public GetPlaylistContentsPart withDuration(Optional<? extends Integer> duration) {
        Utils.checkNotNull(duration, "duration");
        this.duration = duration;
        return this;
    }
    ...
    public GetPlaylistContentsPart withFile(Optional<? extends String> file) {
        Utils.checkNotNull(file, "file");
        this.file = file;
        return this;
    }
    ...
    public GetPlaylistContentsPart withSize(Optional<? extends Integer> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
    ...
    public GetPlaylistContentsPart withAudioProfile(Optional<? extends String> audioProfile) {
        Utils.checkNotNull(audioProfile, "audioProfile");
        this.audioProfile = audioProfile;
        return this;
    }
    ...
    public GetPlaylistContentsPart withContainer(Optional<? extends String> container) {
        Utils.checkNotNull(container, "container");
        this.container = container;
        return this;
    }
    ...
    public GetPlaylistContentsPart withHas64bitOffsets(Optional<? extends Boolean> has64bitOffsets) {
        Utils.checkNotNull(has64bitOffsets, "has64bitOffsets");
        this.has64bitOffsets = has64bitOffsets;
        return this;
    }
    ...
    public GetPlaylistContentsPart withOptimizedForStreaming(Optional<? extends Boolean> optimizedForStreaming) {
        Utils.checkNotNull(optimizedForStreaming, "optimizedForStreaming");
        this.optimizedForStreaming = optimizedForStreaming;
        return this;
    }
    ...
    public GetPlaylistContentsPart withVideoProfile(Optional<? extends String> videoProfile) {
        Utils.checkNotNull(videoProfile, "videoProfile");
        this.videoProfile = videoProfile;
        return this;
    }
