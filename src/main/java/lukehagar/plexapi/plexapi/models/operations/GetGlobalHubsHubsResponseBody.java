...
public class GetGlobalHubsHubsResponseBody {
    ...
    public GetGlobalHubsHubsResponseBody(
    ...
    public GetGlobalHubsHubsResponseBody withErrors(java.util.List<GetGlobalHubsErrors> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = Optional.ofNullable(errors);
        return this;
    }

    public GetGlobalHubsHubsResponseBody withErrors(Optional<? extends java.util.List<GetGlobalHubsErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetGlobalHubsHubsResponseBody other = (GetGlobalHubsHubsResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetGlobalHubsHubsResponseBody.class,
                "errors", errors);
    }
    ...
    public final static class Builder {
        ...
        public GetGlobalHubsHubsResponseBody build() {
            return new GetGlobalHubsHubsResponseBody(
                errors);
        }
    }
}
