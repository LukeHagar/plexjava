...
public class GetMetadataGenre {
    ...
    public GetMetadataGenre withId(int id) {
        Utils.checkNotNull(id, "id");
        this.id = Optional.ofNullable(id);
        return this;
    }

    public GetMetadataGenre withId(Optional<? extends Integer> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
    ...
    public GetMetadataGenre withFilter(Optional<? extends String> filter) {
        Utils.checkNotNull(filter, "filter");
        this.filter = filter;
        return this;
    }
    ...
    public GetMetadataGenre withTag(Optional<? extends String> tag) {
        Utils.checkNotNull(tag, "tag");
        this.tag = tag;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetMetadataGenre other = (GetMetadataGenre) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetMetadataGenre.class,
                "id", id,
                "filter", filter,
                "tag", tag);
    }
    ...
    public final static class Builder {
        ...
        public GetMetadataGenre build() {
            return new GetMetadataGenre(
                id,
                filter,
                tag);
        }
