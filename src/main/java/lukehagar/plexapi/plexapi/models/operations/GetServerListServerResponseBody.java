...
public class GetServerListServerResponseBody {
    ...
    public GetServerListServerResponseBody(
    ...
    public GetServerListServerResponseBody withErrors(java.util.List<GetServerListErrors> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = Optional.ofNullable(errors);
        return this;
    }

    public GetServerListServerResponseBody withErrors(Optional<? extends java.util.List<GetServerListErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetServerListServerResponseBody other = (GetServerListServerResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetServerListServerResponseBody.class,
                "errors", errors);
    }
    ...
    public final static class Builder {
        ...
        public GetServerListServerResponseBody build() {
            return new GetServerListServerResponseBody(
                errors);
        }
    }
}
