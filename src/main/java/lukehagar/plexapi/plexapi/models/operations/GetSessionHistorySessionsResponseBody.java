...
public class GetSessionHistorySessionsResponseBody {
    ...
    public GetSessionHistorySessionsResponseBody(
    ...
    public GetSessionHistorySessionsResponseBody withErrors(java.util.List<GetSessionHistoryErrors> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = Optional.ofNullable(errors);
        return this;
    }

    public GetSessionHistorySessionsResponseBody withErrors(Optional<? extends java.util.List<GetSessionHistoryErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSessionHistorySessionsResponseBody other = (GetSessionHistorySessionsResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSessionHistorySessionsResponseBody.class,
                "errors", errors);
    }
    ...
    public final static class Builder {
        ...
        public GetSessionHistorySessionsResponseBody build() {
            return new GetSessionHistorySessionsResponseBody(
                errors);
        }
    }
}
