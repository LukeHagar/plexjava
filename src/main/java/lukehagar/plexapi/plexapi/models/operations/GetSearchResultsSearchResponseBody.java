...
public class GetSearchResultsSearchResponseBody {
    ...
    public GetSearchResultsSearchResponseBody withErrors(java.util.List<GetSearchResultsErrors> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = Optional.ofNullable(errors);
        return this;
    }

    public GetSearchResultsSearchResponseBody withErrors(Optional<? extends java.util.List<GetSearchResultsErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSearchResultsSearchResponseBody other = (GetSearchResultsSearchResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSearchResultsSearchResponseBody.class,
                "errors", errors);
    }
    ...
    public final static class Builder {
        ...
        public GetSearchResultsSearchResponseBody build() {
