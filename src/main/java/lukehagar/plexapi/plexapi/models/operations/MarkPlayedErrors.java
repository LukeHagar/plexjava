...
public class MarkPlayedErrors {
    ...
    public MarkPlayedErrors withCode(Optional<? extends Double> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
    ...
    public MarkPlayedErrors withMessage(Optional<? extends String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
    ...
    public MarkPlayedErrors withStatus(Optional<? extends Double> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MarkPlayedErrors other = (MarkPlayedErrors) o;
        return 
    ...
    public String toString() {
        return Utils.toString(MarkPlayedErrors.class,
                "code", code,
                "message", message,
                "status", status);
    }
    ...
    public final static class Builder {
        ...
        public MarkPlayedErrors build() {
            return new MarkPlayedErrors(
                code,
                message,
                status);
        }
