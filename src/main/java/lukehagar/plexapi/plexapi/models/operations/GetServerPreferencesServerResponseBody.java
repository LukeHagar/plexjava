...
public class GetServerPreferencesServerResponseBody {
    ...
    public GetServerPreferencesServerResponseBody withErrors(java.util.List<GetServerPreferencesErrors> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = Optional.ofNullable(errors);
        return this;
    }

    public GetServerPreferencesServerResponseBody withErrors(Optional<? extends java.util.List<GetServerPreferencesErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetServerPreferencesServerResponseBody other = (GetServerPreferencesServerResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetServerPreferencesServerResponseBody.class,
                "errors", errors);
    }
    ...
    public final static class Builder {
        ...
        public GetServerPreferencesServerResponseBody build() {
            return new GetServerPreferencesServerResponseBody(
                errors);
        }
    }
}
