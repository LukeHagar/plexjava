...
public class GetMetadataLibraryResponseBody {
    ...
    public GetMetadataLibraryResponseBody withErrors(java.util.List<GetMetadataErrors> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = Optional.ofNullable(errors);
        return this;
    }

    public GetMetadataLibraryResponseBody withErrors(Optional<? extends java.util.List<GetMetadataErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetMetadataLibraryResponseBody other = (GetMetadataLibraryResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetMetadataLibraryResponseBody.class,
                "errors", errors);
    }
    ...
    public final static class Builder {
        ...
        public GetMetadataLibraryResponseBody build() {
