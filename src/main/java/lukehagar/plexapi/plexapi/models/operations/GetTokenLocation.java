...
public class GetTokenLocation {
    ...
    public GetTokenLocation withCode(String code) {
        Utils.checkNotNull(code, "code");
        this.code = Optional.ofNullable(code);
        return this;
    }

    public GetTokenLocation withCode(Optional<? extends String> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }

    public GetTokenLocation withEuropeanUnionMember(boolean europeanUnionMember) {
        Utils.checkNotNull(europeanUnionMember, "europeanUnionMember");
        this.europeanUnionMember = Optional.ofNullable(europeanUnionMember);
        return this;
    }

    public GetTokenLocation withEuropeanUnionMember(Optional<? extends Boolean> europeanUnionMember) {
        Utils.checkNotNull(europeanUnionMember, "europeanUnionMember");
        this.europeanUnionMember = europeanUnionMember;
        return this;
    }

    public GetTokenLocation withContinentCode(String continentCode) {
        Utils.checkNotNull(continentCode, "continentCode");
        this.continentCode = Optional.ofNullable(continentCode);
        return this;
    }

    public GetTokenLocation withContinentCode(Optional<? extends String> continentCode) {
        Utils.checkNotNull(continentCode, "continentCode");
        this.continentCode = continentCode;
        return this;
    }

    public GetTokenLocation withCountry(String country) {
        Utils.checkNotNull(country, "country");
        this.country = Optional.ofNullable(country);
        return this;
    }

    public GetTokenLocation withCountry(Optional<? extends String> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }

    public GetTokenLocation withCity(String city) {
        Utils.checkNotNull(city, "city");
        this.city = Optional.ofNullable(city);
        return this;
    }

    public GetTokenLocation withCity(Optional<? extends String> city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }

    public GetTokenLocation withTimeZone(String timeZone) {
        Utils.checkNotNull(timeZone, "timeZone");
        this.timeZone = Optional.ofNullable(timeZone);
        return this;
    }

    public GetTokenLocation withTimeZone(Optional<? extends String> timeZone) {
        Utils.checkNotNull(timeZone, "timeZone");
        this.timeZone = timeZone;
        return this;
    }

    public GetTokenLocation withPostalCode(String postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = Optional.ofNullable(postalCode);
        return this;
    }

    public GetTokenLocation withPostalCode(Optional<? extends String> postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = postalCode;
        return this;
    }

    public GetTokenLocation withInPrivacyRestrictedCountry(boolean inPrivacyRestrictedCountry) {
        Utils.checkNotNull(inPrivacyRestrictedCountry, "inPrivacyRestrictedCountry");
        this.inPrivacyRestrictedCountry = Optional.ofNullable(inPrivacyRestrictedCountry);
        return this;
    }

    public GetTokenLocation withInPrivacyRestrictedCountry(Optional<? extends Boolean> inPrivacyRestrictedCountry) {
        Utils.checkNotNull(inPrivacyRestrictedCountry, "inPrivacyRestrictedCountry");
        this.inPrivacyRestrictedCountry = inPrivacyRestrictedCountry;
        return this;
    }

    public GetTokenLocation withSubdivisions(String subdivisions) {
        Utils.checkNotNull(subdivisions, "subdivisions");
        this.subdivisions = Optional.ofNullable(subdivisions);
        return this;
    }

    public GetTokenLocation withSubdivisions(Optional<? extends String> subdivisions) {
        Utils.checkNotNull(subdivisions, "subdivisions");
        this.subdivisions = subdivisions;
        return this;
    }

    public GetTokenLocation withCoordinates(String coordinates) {
        Utils.checkNotNull(coordinates, "coordinates");
        this.coordinates = Optional.ofNullable(coordinates);
        return this;
    }

    public GetTokenLocation withCoordinates(Optional<? extends String> coordinates) {
        Utils.checkNotNull(coordinates, "coordinates");
        this.coordinates = coordinates;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetTokenLocation other = (GetTokenLocation) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetTokenLocation.class,
                "code", code,
    ...
    public final static class Builder {
        ...
        public GetTokenLocation build() {
            return new GetTokenLocation(
                code,
                europeanUnionMember,
                continentCode,
                country,
