...
public class GetMetadataMetadata {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<java.util.List<GetMetadataMedia>> media() {
        return (Optional<java.util.List<GetMetadataMedia>>) media;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<java.util.List<GetMetadataGenre>> genre() {
        return (Optional<java.util.List<GetMetadataGenre>>) genre;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<java.util.List<GetMetadataCountry>> country() {
        return (Optional<java.util.List<GetMetadataCountry>>) country;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<java.util.List<Guids>> guids() {
        return (Optional<java.util.List<Guids>>) guids;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<java.util.List<Ratings>> ratings() {
        return (Optional<java.util.List<Ratings>>) ratings;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<java.util.List<GetMetadataDirector>> director() {
        return (Optional<java.util.List<GetMetadataDirector>>) director;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<java.util.List<GetMetadataWriter>> writer() {
        return (Optional<java.util.List<GetMetadataWriter>>) writer;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<java.util.List<GetMetadataRole>> role() {
        return (Optional<java.util.List<GetMetadataRole>>) role;
    }

    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<java.util.List<Producer>> producer() {
        return (Optional<java.util.List<Producer>>) producer;
    }
