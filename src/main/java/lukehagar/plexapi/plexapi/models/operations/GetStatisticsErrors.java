...
public class GetStatisticsErrors {
    ...
    public GetStatisticsErrors withCode(double code) {
        Utils.checkNotNull(code, "code");
        this.code = Optional.ofNullable(code);
        return this;
    }

    public GetStatisticsErrors withCode(Optional<? extends Double> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }

    public GetStatisticsErrors withMessage(String message) {
        Utils.checkNotNull(message, "message");
        this.message = Optional.ofNullable(message);
        return this;
    }

    public GetStatisticsErrors withMessage(Optional<? extends String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }

    public GetStatisticsErrors withStatus(double status) {
        Utils.checkNotNull(status, "status");
        this.status = Optional.ofNullable(status);
        return this;
    }

    public GetStatisticsErrors withStatus(Optional<? extends Double> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetStatisticsErrors other = (GetStatisticsErrors) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetStatisticsErrors.class,
                "code", code,
                "message", message,
                "status", status);
    }
    ...
    public final static class Builder {
        ...
        public GetStatisticsErrors build() {
            return new GetStatisticsErrors(
                code,
                message,
                status);
        }
