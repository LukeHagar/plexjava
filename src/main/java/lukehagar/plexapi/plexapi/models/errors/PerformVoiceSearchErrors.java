...
public class PerformVoiceSearchErrors {
    ...
    @JsonCreator
    public PerformVoiceSearchErrors(
    ...
    public PerformVoiceSearchErrors withCode(double code) {
        Utils.checkNotNull(code, "code");
        this.code = Optional.ofNullable(code);
        return this;
    }

    public PerformVoiceSearchErrors withCode(Optional<? extends Double> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }

    public PerformVoiceSearchErrors withMessage(String message) {
        Utils.checkNotNull(message, "message");
        this.message = Optional.ofNullable(message);
        return this;
    }

    public PerformVoiceSearchErrors withMessage(Optional<? extends String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }

    public PerformVoiceSearchErrors withStatus(double status) {
        Utils.checkNotNull(status, "status");
        this.status = Optional.ofNullable(status);
        return this;
    }

    public PerformVoiceSearchErrors withStatus(Optional<? extends Double> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(PerformVoiceSearchErrors.class,
                "code", code,
                "message", message,
                "status", status);
    }
