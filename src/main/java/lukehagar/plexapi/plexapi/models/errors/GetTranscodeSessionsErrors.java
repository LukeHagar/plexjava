...
public class GetTranscodeSessionsErrors {
    ...
    @JsonCreator
    public GetTranscodeSessionsErrors(
    ...
    public GetTranscodeSessionsErrors withCode(double code) {
        Utils.checkNotNull(code, "code");
        this.code = Optional.ofNullable(code);
        return this;
    }

    public GetTranscodeSessionsErrors withCode(Optional<? extends Double> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }

    public GetTranscodeSessionsErrors withMessage(String message) {
        Utils.checkNotNull(message, "message");
        this.message = Optional.ofNullable(message);
        return this;
    }

    public GetTranscodeSessionsErrors withMessage(Optional<? extends String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }

    public GetTranscodeSessionsErrors withStatus(double status) {
        Utils.checkNotNull(status, "status");
        this.status = Optional.ofNullable(status);
        return this;
    }

    public GetTranscodeSessionsErrors withStatus(Optional<? extends Double> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetTranscodeSessionsErrors other = (GetTranscodeSessionsErrors) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetTranscodeSessionsErrors.class,
                "code", code,
                "message", message,
                "status", status);
    }
    ...
    public final static class Builder {
        ...
        public GetTranscodeSessionsErrors build() {
            return new GetTranscodeSessionsErrors(
                code,
                message,
                status);
        }
