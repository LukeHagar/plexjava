...
import dev.plexapi.sdk.models.operations.GetScheduledRecordingsResponseBody;
...
public class GetScheduledRecordings {
    ...
    public static class Sync extends Base
        ...
        @Override
        public GetScheduledRecordingsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetScheduledRecordingsResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
