...
public class GetPostplayHubs {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPostplayHubsRequest request) throws Exception {
        ...
        @Override
        public GetPostplayHubsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    MediaContainerWithHubs out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMediaContainerWithHubs(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
