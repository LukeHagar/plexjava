...
public class GetItemDecision {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetItemDecisionRequest request) throws Exception {
        ...
        @Override
        public GetItemDecisionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    MediaContainerWithDecision out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMediaContainerWithDecision(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
