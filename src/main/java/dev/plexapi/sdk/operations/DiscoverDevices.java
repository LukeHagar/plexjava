...
public class DiscoverDevices {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<DiscoverDevicesResponse> {
        ...
        @Override
        public DiscoverDevicesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    MediaContainerWithDevice out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMediaContainerWithDevice(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<dev.plexapi.sdk.models.operations.async.DiscoverDevicesResponse> {
