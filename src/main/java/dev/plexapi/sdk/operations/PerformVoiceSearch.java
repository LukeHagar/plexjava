...
public class PerformVoiceSearch {
    ...
    public static class Sync extends Base
            implements RequestOperation<PerformVoiceSearchRequest, PerformVoiceSearchResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(PerformVoiceSearchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PerformVoiceSearchRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PerformVoiceSearchRequest request) throws Exception {
        ...
        @Override
        public PerformVoiceSearchResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PerformVoiceSearchResponse.Builder resBuilder =
            ...
            PerformVoiceSearchResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PerformVoiceSearchBadRequest out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "401")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PerformVoiceSearchUnauthorized out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                        out.withRawResponse(response);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PerformVoiceSearchRequest, dev.plexapi.sdk.models.operations.async.PerformVoiceSearchResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PerformVoiceSearchRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PerformVoiceSearchRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PerformVoiceSearchRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.PerformVoiceSearchResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.PerformVoiceSearchResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.PerformVoiceSearchResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.PerformVoiceSearchResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        dev.plexapi.sdk.models.errors.async.PerformVoiceSearchBadRequest out;
                        try {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "401")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        dev.plexapi.sdk.models.errors.async.PerformVoiceSearchUnauthorized out;
                        try {
                            out = Utils.mapper().readValue(
                                    bodyBytes,
                                    new TypeReference<>() {
