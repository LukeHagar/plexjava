...
public class StartTranscodeSession {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            ...
            req.addHeader("Accept", "video/x-matroska")
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StartTranscodeSessionRequest request) throws Exception {
        ...
        @Override
        public StartTranscodeSessionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "video/x-matroska")) {
                    return res;
                } else {
                    throw new SDKError(
                            response,
