...
public class GetRecentlyAdded {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRecentlyAddedRequest, GetRecentlyAddedResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(GetRecentlyAddedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRecentlyAddedRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRecentlyAddedRequest request) throws Exception {
        ...
        @Override
        public GetRecentlyAddedResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetRecentlyAddedResponse.Builder resBuilder =
            ...
            GetRecentlyAddedResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetRecentlyAddedResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetRecentlyAddedRequest, dev.plexapi.sdk.models.operations.async.GetRecentlyAddedResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetRecentlyAddedRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRecentlyAddedRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRecentlyAddedRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetRecentlyAddedResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetRecentlyAddedResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetRecentlyAddedResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetRecentlyAddedResponse res = resBuilder.build();
