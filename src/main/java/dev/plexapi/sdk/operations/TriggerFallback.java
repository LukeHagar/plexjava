...
public class TriggerFallback {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TriggerFallbackRequest request) throws Exception {
            HttpRequest r = onBuildRequest(request);
            HttpResponse<InputStream> httpRes;
            try {
                httpRes = client.send(r);
                if (Utils.statusCodeMatches(httpRes.statusCode(), "404", "412", "4XX", "500", "5XX")) {
        ...
        @Override
        public TriggerFallbackResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        ...
        public CompletableFuture<HttpResponse<Blob>> doRequest(TriggerFallbackRequest request) {
            return Exceptions.unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        ...
                        if (Utils.statusCodeMatches(resp.statusCode(), "404", "412", "4XX", "500", "5XX")) {
