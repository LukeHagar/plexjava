...
public class GetItemTree {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetItemTreeRequest request) throws Exception {
        ...
        @Override
        public GetItemTreeResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    MediaContainerWithNestedMetadata out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMediaContainerWithNestedMetadata(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
