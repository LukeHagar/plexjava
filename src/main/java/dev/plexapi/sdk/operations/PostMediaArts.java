...
public class PostMediaArts {
    ...
    public static class Sync extends Base
            implements RequestOperation<PostMediaArtsRequest, PostMediaArtsResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(PostMediaArtsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostMediaArtsRequest.class, new TypeReference<PostMediaArtsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostMediaArtsRequest request) throws Exception {
        ...
        @Override
        public PostMediaArtsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostMediaArtsResponse.Builder resBuilder =
            ...
            PostMediaArtsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostMediaArtsRequest, dev.plexapi.sdk.models.operations.async.PostMediaArtsResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostMediaArtsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostMediaArtsRequest.class, new TypeReference<PostMediaArtsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostMediaArtsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.PostMediaArtsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.PostMediaArtsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.PostMediaArtsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.PostMediaArtsResponse res = resBuilder.build();
