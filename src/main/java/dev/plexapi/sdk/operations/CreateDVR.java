...
public class CreateDVR {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateDVRRequest request) throws Exception {
        ...
        @Override
        public CreateDVRResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DvrRequestHandlerSlashGetResponses200 out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDvrRequestHandlerSlashGetResponses200(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
