...
public class GetRecentlyAddedLibrary {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRecentlyAddedLibraryRequest, GetRecentlyAddedLibraryResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(GetRecentlyAddedLibraryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRecentlyAddedLibraryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRecentlyAddedLibraryRequest request) throws Exception {
        ...
        @Override
        public GetRecentlyAddedLibraryResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetRecentlyAddedLibraryResponse.Builder resBuilder =
            ...
            GetRecentlyAddedLibraryResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetRecentlyAddedLibraryResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetRecentlyAddedLibraryBadRequest out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "401")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetRecentlyAddedLibraryUnauthorized out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                        out.withRawResponse(response);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetRecentlyAddedLibraryRequest, dev.plexapi.sdk.models.operations.async.GetRecentlyAddedLibraryResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetRecentlyAddedLibraryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRecentlyAddedLibraryRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRecentlyAddedLibraryRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetRecentlyAddedLibraryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetRecentlyAddedLibraryResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetRecentlyAddedLibraryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetRecentlyAddedLibraryResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        dev.plexapi.sdk.models.errors.async.GetRecentlyAddedLibraryBadRequest out;
                        try {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "401")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        dev.plexapi.sdk.models.errors.async.GetRecentlyAddedLibraryUnauthorized out;
                        try {
                            out = Utils.mapper().readValue(
                                    bodyBytes,
                                    new TypeReference<>() {
