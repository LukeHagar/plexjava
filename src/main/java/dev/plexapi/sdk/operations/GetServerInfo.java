...
public class GetServerInfo {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetServerInfoRequest request) throws Exception {
        ...
        public GetServerInfoResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    MediaContainerWithDirectory out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMediaContainerWithDirectory(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
