...
public class EditMarker {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EditMarkerRequest request) throws Exception {
        ...
        @Override
        public EditMarkerResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PostResponses200 out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPostResponses200(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
