...
public class DeleteHistory {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteHistoryRequest request) throws Exception {
        ...
        @Override
        public DeleteHistoryResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    MediaContainer out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMediaContainer(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
