...
public class DeleteCollectionItem {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(DeleteCollectionItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteCollectionItemRequest.class);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteCollectionItemRequest, dev.plexapi.sdk.models.operations.async.DeleteCollectionItemResponse> {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.DeleteCollectionItemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.DeleteCollectionItemResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.DeleteCollectionItemResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.DeleteCollectionItemResponse res = resBuilder.build();
