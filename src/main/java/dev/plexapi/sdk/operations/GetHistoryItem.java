...
public class GetHistoryItem {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHistoryItemRequest request) throws Exception {
        ...
        @Override
        public GetHistoryItemResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    HistoryAllGetResponses200 out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withHistoryAllGetResponses200(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
