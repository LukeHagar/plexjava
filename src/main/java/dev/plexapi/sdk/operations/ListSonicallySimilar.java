...
public class ListSonicallySimilar {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSonicallySimilarRequest, ListSonicallySimilarResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(ListSonicallySimilarRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSonicallySimilarRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSonicallySimilarRequest request) throws Exception {
        ...
        @Override
        public ListSonicallySimilarResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListSonicallySimilarResponse.Builder resBuilder =
            ...
            ListSonicallySimilarResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSonicallySimilarRequest, dev.plexapi.sdk.models.operations.async.ListSonicallySimilarResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListSonicallySimilarRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSonicallySimilarRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSonicallySimilarRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.ListSonicallySimilarResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.ListSonicallySimilarResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.ListSonicallySimilarResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.ListSonicallySimilarResponse res = resBuilder.build();
