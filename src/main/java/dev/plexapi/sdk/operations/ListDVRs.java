...
import dev.plexapi.sdk.models.operations.ListDVRsResponseBody;
...
public class ListDVRs {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<ListDVRsResponse> {
        ...
        @Override
        public ListDVRsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ListDVRsResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<dev.plexapi.sdk.models.operations.async.ListDVRsResponse> {
