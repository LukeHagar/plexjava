...
public class GetAugmentationStatus {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAugmentationStatusRequest request) throws Exception {
        ...
        @Override
        public GetAugmentationStatusResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        ...
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAugmentationStatusRequest request) {
            return Exceptions.unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        ...
                        if (Utils.statusCodeMatches(resp.statusCode(), "401", "404", "4XX", "5XX")) {
