...
public class EditSubscriptionPreferences {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EditSubscriptionPreferencesRequest request) throws Exception {
        ...
        @Override
        public EditSubscriptionPreferencesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    MediaContainerWithSubscription out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMediaContainerWithSubscription(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
