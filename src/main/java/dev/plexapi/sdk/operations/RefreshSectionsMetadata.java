...
public class RefreshSectionsMetadata {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RefreshSectionsMetadataRequest request) throws Exception {
            HttpRequest r = onBuildRequest(request);
            HttpResponse<InputStream> httpRes;
            try {
                httpRes = client.send(r);
                if (Utils.statusCodeMatches(httpRes.statusCode(), "4XX", "503", "5XX")) {
        ...
        @Override
        public RefreshSectionsMetadataResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        ...
        public CompletableFuture<HttpResponse<Blob>> doRequest(RefreshSectionsMetadataRequest request) {
            return Exceptions.unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        ...
                        if (Utils.statusCodeMatches(resp.statusCode(), "4XX", "503", "5XX")) {
