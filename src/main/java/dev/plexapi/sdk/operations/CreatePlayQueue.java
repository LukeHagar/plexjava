...
import dev.plexapi.sdk.models.operations.CreatePlayQueueResponseBody;
...
public class CreatePlayQueue {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreatePlayQueueRequest request) throws Exception {
        ...
        @Override
        public CreatePlayQueueResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CreatePlayQueueResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
