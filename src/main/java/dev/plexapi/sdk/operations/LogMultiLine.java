...
public class LogMultiLine {
    ...
    public static class Sync extends Base
            implements RequestOperation<String, LogMultiLineResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(String request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<String>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(String request) throws Exception {
        ...
        @Override
        public LogMultiLineResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            LogMultiLineResponse.Builder resBuilder =
            ...
            LogMultiLineResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    LogMultiLineBadRequest out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "401")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    LogMultiLineUnauthorized out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                        out.withRawResponse(response);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<String, dev.plexapi.sdk.models.operations.async.LogMultiLineResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(String request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<String>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(String request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.LogMultiLineResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.LogMultiLineResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.LogMultiLineResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.LogMultiLineResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        dev.plexapi.sdk.models.errors.async.LogMultiLineBadRequest out;
                        try {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "401")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        dev.plexapi.sdk.models.errors.async.LogMultiLineUnauthorized out;
                        try {
                            out = Utils.mapper().readValue(
                                    bodyBytes,
                                    new TypeReference<>() {
