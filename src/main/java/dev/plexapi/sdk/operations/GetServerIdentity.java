...
public class GetServerIdentity {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<GetServerIdentityResponse> {
        ...
        public HttpResponse<InputStream> doRequest() throws Exception {
            ...
            try {
                ...
                if (Utils.statusCodeMatches(httpRes.statusCode(), "408", "4XX", "5XX")) {
        ...
        @Override
        public GetServerIdentityResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetServerIdentityResponse.Builder resBuilder =
            ...
            GetServerIdentityResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetServerIdentityResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "408")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetServerIdentityRequestTimeout out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<dev.plexapi.sdk.models.operations.async.GetServerIdentityResponse> {
        ...
        public CompletableFuture<HttpResponse<Blob>> doRequest() {
            return Exceptions.unchecked(() -> onBuildRequest()).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        ...
                        if (Utils.statusCodeMatches(resp.statusCode(), "408", "4XX", "5XX")) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetServerIdentityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetServerIdentityResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetServerIdentityResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetServerIdentityResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "408")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        dev.plexapi.sdk.models.errors.async.GetServerIdentityRequestTimeout out;
                        try {
