...
public class GetMediaPosters {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMediaPostersRequest, GetMediaPostersResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(GetMediaPostersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMediaPostersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMediaPostersRequest request) throws Exception {
        ...
        @Override
        public GetMediaPostersResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMediaPostersResponse.Builder resBuilder =
            ...
            GetMediaPostersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetMediaPostersResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMediaPostersRequest, dev.plexapi.sdk.models.operations.async.GetMediaPostersResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetMediaPostersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMediaPostersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMediaPostersRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetMediaPostersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetMediaPostersResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetMediaPostersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetMediaPostersResponse res = resBuilder.build();
