...
public class AddSection {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddSectionRequest request) throws Exception {
        ...
        @Override
        public AddSectionResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    SlashGetResponses200 out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withSlashGetResponses200(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
