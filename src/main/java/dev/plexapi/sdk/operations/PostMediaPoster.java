...
public class PostMediaPoster {
    ...
    public static class Sync extends Base
            implements RequestOperation<PostMediaPosterRequest, PostMediaPosterResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(PostMediaPosterRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostMediaPosterRequest.class, new TypeReference<PostMediaPosterRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostMediaPosterRequest request) throws Exception {
        ...
        @Override
        public PostMediaPosterResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostMediaPosterResponse.Builder resBuilder =
            ...
            PostMediaPosterResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostMediaPosterRequest, dev.plexapi.sdk.models.operations.async.PostMediaPosterResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostMediaPosterRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostMediaPosterRequest.class, new TypeReference<PostMediaPosterRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostMediaPosterRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.PostMediaPosterResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.PostMediaPosterResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.PostMediaPosterResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.PostMediaPosterResponse res = resBuilder.build();
