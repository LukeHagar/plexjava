...
public class UpdatePlayProgress {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdatePlayProgressRequest, UpdatePlayProgressResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(UpdatePlayProgressRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePlayProgressRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdatePlayProgressRequest request) throws Exception {
        ...
        @Override
        public UpdatePlayProgressResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdatePlayProgressResponse.Builder resBuilder =
            ...
            UpdatePlayProgressResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UpdatePlayProgressBadRequest out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "401")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    UpdatePlayProgressUnauthorized out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                        out.withRawResponse(response);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdatePlayProgressRequest, dev.plexapi.sdk.models.operations.async.UpdatePlayProgressResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdatePlayProgressRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatePlayProgressRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdatePlayProgressRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.UpdatePlayProgressResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.UpdatePlayProgressResponse.Builder resBuilder =
            ...
            dev.plexapi.sdk.models.operations.async.UpdatePlayProgressResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        dev.plexapi.sdk.models.errors.async.UpdatePlayProgressBadRequest out;
                        try {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "401")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        dev.plexapi.sdk.models.errors.async.UpdatePlayProgressUnauthorized out;
                        try {
                            out = Utils.mapper().readValue(
                                    bodyBytes,
                                    new TypeReference<>() {
