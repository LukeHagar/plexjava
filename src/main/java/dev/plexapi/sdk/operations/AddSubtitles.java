...
public class AddSubtitles {
    ...
    public static class Sync extends Base
            implements RequestOperation<AddSubtitlesRequest, AddSubtitlesResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(AddSubtitlesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddSubtitlesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddSubtitlesRequest request) throws Exception {
        ...
        @Override
        public AddSubtitlesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddSubtitlesResponse.Builder resBuilder =
            ...
            AddSubtitlesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddSubtitlesRequest, dev.plexapi.sdk.models.operations.async.AddSubtitlesResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(AddSubtitlesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddSubtitlesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddSubtitlesRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.AddSubtitlesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.AddSubtitlesResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.AddSubtitlesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.AddSubtitlesResponse res = resBuilder.build();
