...
public class MoveHub {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(MoveHubRequest request) throws Exception {
        ...
        @Override
        public MoveHubResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetResponses200 out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGetResponses200(out);
                    return res;
                } else {
                    throw new SDKError(
                            response,
