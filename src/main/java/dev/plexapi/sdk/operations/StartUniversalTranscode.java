...
public class StartUniversalTranscode {
    ...
    public static class Sync extends Base
            implements RequestOperation<StartUniversalTranscodeRequest, StartUniversalTranscodeResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(StartUniversalTranscodeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StartUniversalTranscodeRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(StartUniversalTranscodeRequest request) throws Exception {
        ...
        @Override
        public StartUniversalTranscodeResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            StartUniversalTranscodeResponse.Builder resBuilder =
            ...
            StartUniversalTranscodeResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    StartUniversalTranscodeBadRequest out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "401")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    StartUniversalTranscodeUnauthorized out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                        out.withRawResponse(response);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<StartUniversalTranscodeRequest, dev.plexapi.sdk.models.operations.async.StartUniversalTranscodeResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(StartUniversalTranscodeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, StartUniversalTranscodeRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(StartUniversalTranscodeRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.StartUniversalTranscodeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.StartUniversalTranscodeResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.StartUniversalTranscodeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.StartUniversalTranscodeResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        dev.plexapi.sdk.models.errors.async.StartUniversalTranscodeBadRequest out;
                        try {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "401")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        dev.plexapi.sdk.models.errors.async.StartUniversalTranscodeUnauthorized out;
                        try {
                            out = Utils.mapper().readValue(
                                    bodyBytes,
                                    new TypeReference<>() {
