...
public class GetLibrarySectionsAll {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLibrarySectionsAllRequest, GetLibrarySectionsAllResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(GetLibrarySectionsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLibrarySectionsAllRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLibrarySectionsAllRequest request) throws Exception {
        ...
        @Override
        public GetLibrarySectionsAllResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLibrarySectionsAllResponse.Builder resBuilder =
            ...
            GetLibrarySectionsAllResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetLibrarySectionsAllResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetLibrarySectionsAllBadRequest out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "401")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetLibrarySectionsAllUnauthorized out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                        out.withRawResponse(response);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLibrarySectionsAllRequest, dev.plexapi.sdk.models.operations.async.GetLibrarySectionsAllResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetLibrarySectionsAllRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLibrarySectionsAllRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLibrarySectionsAllRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetLibrarySectionsAllResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetLibrarySectionsAllResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetLibrarySectionsAllResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetLibrarySectionsAllResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        dev.plexapi.sdk.models.errors.async.GetLibrarySectionsAllBadRequest out;
                        try {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "401")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        dev.plexapi.sdk.models.errors.async.GetLibrarySectionsAllUnauthorized out;
                        try {
                            out = Utils.mapper().readValue(
                                    bodyBytes,
                                    new TypeReference<>() {
