...
public class GetTransientToken {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTransientTokenRequest, GetTransientTokenResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(GetTransientTokenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTransientTokenRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTransientTokenRequest request) throws Exception {
        ...
        @Override
        public GetTransientTokenResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTransientTokenResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTransientTokenRequest, dev.plexapi.sdk.models.operations.async.GetTransientTokenResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetTransientTokenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTransientTokenRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTransientTokenRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetTransientTokenResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetTransientTokenResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetTransientTokenResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
