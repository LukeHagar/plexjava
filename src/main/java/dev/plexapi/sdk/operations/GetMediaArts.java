...
public class GetMediaArts {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMediaArtsRequest, GetMediaArtsResponse> {
        public Sync(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(GetMediaArtsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMediaArtsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMediaArtsRequest request) throws Exception {
        ...
        @Override
        public GetMediaArtsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMediaArtsResponse.Builder resBuilder =
            ...
            GetMediaArtsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetMediaArtsResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMediaArtsRequest, dev.plexapi.sdk.models.operations.async.GetMediaArtsResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetMediaArtsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMediaArtsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMediaArtsRequest request) {
        ...
        @Override
        public CompletableFuture<dev.plexapi.sdk.models.operations.async.GetMediaArtsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            dev.plexapi.sdk.models.operations.async.GetMediaArtsResponse.Builder resBuilder =
                    dev.plexapi.sdk.models.operations.async.GetMediaArtsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            dev.plexapi.sdk.models.operations.async.GetMediaArtsResponse res = resBuilder.build();
