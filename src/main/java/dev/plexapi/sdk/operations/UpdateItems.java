...
public class UpdateItems {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateItemsRequest request) throws Exception {
            HttpRequest r = onBuildRequest(request);
            HttpResponse<InputStream> httpRes;
            try {
                httpRes = client.send(r);
                if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "404", "409", "4XX", "5XX")) {
        ...
        @Override
        public UpdateItemsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
        ...
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateItemsRequest request) {
            return Exceptions.unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        ...
                        if (Utils.statusCodeMatches(resp.statusCode(), "400", "404", "409", "4XX", "5XX")) {
