...
import dev.plexapi.sdk.models.errors.GetActorsLibraryLibraryErrors;
...
public class GetActorsLibraryUnauthorized extends RuntimeException {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetActorsLibraryUnauthorized withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetActorsLibraryUnauthorized withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
