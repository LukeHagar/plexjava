...
public class GetTokenByPinIdErrors {
    ...
    public GetTokenByPinIdErrors withMessage(String message) {
        Utils.checkNotNull(message, "message");
        this.message = Optional.ofNullable(message);
        return this;
    }

    public GetTokenByPinIdErrors withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetTokenByPinIdErrors other = (GetTokenByPinIdErrors) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetTokenByPinIdErrors.class,
                "code", code,
                "message", message,
                "status", status);
    }
    ...
    public final static class Builder {
        ...
        public GetTokenByPinIdErrors build() {
            return new GetTokenByPinIdErrors(
                code,
                message,
                status);
        }
