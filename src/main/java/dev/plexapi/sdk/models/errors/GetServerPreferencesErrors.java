...
public class GetServerPreferencesErrors {
    ...
    public GetServerPreferencesErrors withCode(Optional<Double> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
    ...
    public GetServerPreferencesErrors withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
    ...
    public GetServerPreferencesErrors withStatus(Optional<Double> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
