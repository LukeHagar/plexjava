...
public class MarkUnplayedErrors {
    ...
    public MarkUnplayedErrors withCode(Optional<Double> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
    ...
    public MarkUnplayedErrors withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
    ...
    public MarkUnplayedErrors withStatus(Optional<Double> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
