...
public class GetSearchLibraryLibraryErrors {
    ...
    public GetSearchLibraryLibraryErrors withMessage(String message) {
        Utils.checkNotNull(message, "message");
        this.message = Optional.ofNullable(message);
        return this;
    }

    public GetSearchLibraryLibraryErrors withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSearchLibraryLibraryErrors other = (GetSearchLibraryLibraryErrors) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSearchLibraryLibraryErrors.class,
                "code", code,
                "message", message,
                "status", status);
    }
    ...
    public final static class Builder {
        ...
        public GetSearchLibraryLibraryErrors build() {
            return new GetSearchLibraryLibraryErrors(
                code,
                message,
                status);
        }
