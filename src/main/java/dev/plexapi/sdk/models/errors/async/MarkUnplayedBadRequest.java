...
import dev.plexapi.sdk.models.errors.MarkUnplayedErrors;
...
public class MarkUnplayedBadRequest extends RuntimeException {
    ...
    public MarkUnplayedBadRequest withErrors(List<MarkUnplayedErrors> errors) {
        Utils.checkNotNull(errors, "errors");
    ...
    public MarkUnplayedBadRequest withErrors(Optional<? extends List<MarkUnplayedErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public MarkUnplayedBadRequest withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public MarkUnplayedBadRequest withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MarkUnplayedBadRequest other = (MarkUnplayedBadRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(MarkUnplayedBadRequest.class,
                "errors", errors,
    ...
    public final static class Builder {
        ...
        public MarkUnplayedBadRequest build() {

            return new MarkUnplayedBadRequest(
                errors, rawResponse);
        }
