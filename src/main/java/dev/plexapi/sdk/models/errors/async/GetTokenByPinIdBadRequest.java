...
import dev.plexapi.sdk.models.errors.GetTokenByPinIdErrors;
...
public class GetTokenByPinIdBadRequest extends RuntimeException {
    ...
    public GetTokenByPinIdBadRequest withErrors(List<GetTokenByPinIdErrors> errors) {
        Utils.checkNotNull(errors, "errors");
    ...
    public GetTokenByPinIdBadRequest withErrors(Optional<? extends List<GetTokenByPinIdErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetTokenByPinIdBadRequest withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetTokenByPinIdBadRequest withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetTokenByPinIdBadRequest other = (GetTokenByPinIdBadRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetTokenByPinIdBadRequest.class,
                "errors", errors,
    ...
    public final static class Builder {
        ...
        public GetTokenByPinIdBadRequest build() {

            return new GetTokenByPinIdBadRequest(
                errors, rawResponse);
        }
