...
public class UpdatePlaylistErrors {
    ...
    public UpdatePlaylistErrors withCode(int code) {
        Utils.checkNotNull(code, "code");
        this.code = Optional.ofNullable(code);
        return this;
    }

    public UpdatePlaylistErrors withCode(Optional<Integer> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
    ...
    public UpdatePlaylistErrors withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }

    public UpdatePlaylistErrors withStatus(int status) {
        Utils.checkNotNull(status, "status");
        this.status = Optional.ofNullable(status);
        return this;
    }

    public UpdatePlaylistErrors withStatus(Optional<Integer> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
