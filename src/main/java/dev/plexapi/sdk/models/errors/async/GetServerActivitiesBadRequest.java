...
import dev.plexapi.sdk.models.errors.GetServerActivitiesErrors;
...
public class GetServerActivitiesBadRequest extends RuntimeException {
    ...
    public GetServerActivitiesBadRequest withErrors(List<GetServerActivitiesErrors> errors) {
        Utils.checkNotNull(errors, "errors");
    ...
    public GetServerActivitiesBadRequest withErrors(Optional<? extends List<GetServerActivitiesErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetServerActivitiesBadRequest withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetServerActivitiesBadRequest withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetServerActivitiesBadRequest other = (GetServerActivitiesBadRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetServerActivitiesBadRequest.class,
                "errors", errors,
    ...
    public final static class Builder {
        ...
        public GetServerActivitiesBadRequest build() {

            return new GetServerActivitiesBadRequest(
                errors, rawResponse);
        }
