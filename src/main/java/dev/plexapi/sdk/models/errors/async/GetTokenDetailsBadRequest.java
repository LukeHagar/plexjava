...
import dev.plexapi.sdk.models.errors.Errors;
...
public class GetTokenDetailsBadRequest extends RuntimeException {
    ...
    public GetTokenDetailsBadRequest withErrors(List<Errors> errors) {
        Utils.checkNotNull(errors, "errors");
    ...
    public GetTokenDetailsBadRequest withErrors(Optional<? extends List<Errors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
