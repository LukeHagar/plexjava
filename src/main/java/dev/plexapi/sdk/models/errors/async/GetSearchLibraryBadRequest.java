...
import dev.plexapi.sdk.models.errors.GetSearchLibraryErrors;
...
public class GetSearchLibraryBadRequest extends RuntimeException {
    ...
    public GetSearchLibraryBadRequest withErrors(List<GetSearchLibraryErrors> errors) {
        Utils.checkNotNull(errors, "errors");
    ...
    public GetSearchLibraryBadRequest withErrors(Optional<? extends List<GetSearchLibraryErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetSearchLibraryBadRequest withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetSearchLibraryBadRequest withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSearchLibraryBadRequest other = (GetSearchLibraryBadRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSearchLibraryBadRequest.class,
                "errors", errors,
    ...
    public final static class Builder {
        ...
        public GetSearchLibraryBadRequest build() {

            return new GetSearchLibraryBadRequest(
                errors, rawResponse);
        }
