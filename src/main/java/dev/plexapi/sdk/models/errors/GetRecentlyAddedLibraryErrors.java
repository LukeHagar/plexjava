...
public class GetRecentlyAddedLibraryErrors {
    ...
    public GetRecentlyAddedLibraryErrors withMessage(String message) {
        Utils.checkNotNull(message, "message");
        this.message = Optional.ofNullable(message);
        return this;
    }

    public GetRecentlyAddedLibraryErrors withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetRecentlyAddedLibraryErrors other = (GetRecentlyAddedLibraryErrors) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetRecentlyAddedLibraryErrors.class,
                "code", code,
                "message", message,
                "status", status);
    }
    ...
    public final static class Builder {
        ...
        public GetRecentlyAddedLibraryErrors build() {
