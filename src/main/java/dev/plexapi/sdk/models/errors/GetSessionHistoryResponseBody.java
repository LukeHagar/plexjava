...
public class GetSessionHistoryResponseBody extends RuntimeException {
    ...
    public GetSessionHistoryResponseBody withErrors(List<GetSessionHistoryErrors> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = Optional.ofNullable(errors);
        return this;
    }
    
    public GetSessionHistoryResponseBody withErrors(Optional<? extends List<GetSessionHistoryErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
