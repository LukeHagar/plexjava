...
import dev.plexapi.sdk.models.errors.GetBandwidthStatisticsErrors;
...
public class GetBandwidthStatisticsBadRequest extends RuntimeException {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetBandwidthStatisticsBadRequest withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetBandwidthStatisticsBadRequest withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
