...
import dev.plexapi.sdk.models.errors.DeletePlaylistPlaylistsErrors;
...
public class DeletePlaylistUnauthorized extends RuntimeException {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public DeletePlaylistUnauthorized withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public DeletePlaylistUnauthorized withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
