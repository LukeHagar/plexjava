...
public class GetSessionsSessionsErrors {
    ...
    public GetSessionsSessionsErrors withMessage(String message) {
        Utils.checkNotNull(message, "message");
    ...
    public GetSessionsSessionsErrors withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSessionsSessionsErrors other = (GetSessionsSessionsErrors) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSessionsSessionsErrors.class,
                "code", code,
                "message", message,
                "status", status);
    }
    ...
    public final static class Builder {
        ...
        public GetSessionsSessionsErrors build() {

            return new GetSessionsSessionsErrors(
                code, message, status);
        }
