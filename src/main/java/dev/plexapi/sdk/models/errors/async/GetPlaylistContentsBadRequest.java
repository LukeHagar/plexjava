...
import dev.plexapi.sdk.models.errors.GetPlaylistContentsErrors;
...
public class GetPlaylistContentsBadRequest extends RuntimeException {
    ...
    public GetPlaylistContentsBadRequest withErrors(List<GetPlaylistContentsErrors> errors) {
        Utils.checkNotNull(errors, "errors");
    ...
    public GetPlaylistContentsBadRequest withErrors(Optional<? extends List<GetPlaylistContentsErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetPlaylistContentsBadRequest withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetPlaylistContentsBadRequest withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetPlaylistContentsBadRequest other = (GetPlaylistContentsBadRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetPlaylistContentsBadRequest.class,
                "errors", errors,
    ...
    public final static class Builder {
        ...
        public GetPlaylistContentsBadRequest build() {

            return new GetPlaylistContentsBadRequest(
                errors, rawResponse);
        }
