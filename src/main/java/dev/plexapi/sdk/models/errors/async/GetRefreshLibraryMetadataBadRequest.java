...
import dev.plexapi.sdk.models.errors.GetRefreshLibraryMetadataErrors;
...
public class GetRefreshLibraryMetadataBadRequest extends RuntimeException {
    ...
    public GetRefreshLibraryMetadataBadRequest withErrors(List<GetRefreshLibraryMetadataErrors> errors) {
        Utils.checkNotNull(errors, "errors");
    ...
    public GetRefreshLibraryMetadataBadRequest withErrors(Optional<? extends List<GetRefreshLibraryMetadataErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetRefreshLibraryMetadataBadRequest withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetRefreshLibraryMetadataBadRequest withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetRefreshLibraryMetadataBadRequest other = (GetRefreshLibraryMetadataBadRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetRefreshLibraryMetadataBadRequest.class,
                "errors", errors,
    ...
    public final static class Builder {
        ...
        public GetRefreshLibraryMetadataBadRequest build() {

            return new GetRefreshLibraryMetadataBadRequest(
                errors, rawResponse);
        }
