...
import dev.plexapi.sdk.models.errors.GetMyPlexAccountErrors;
...
public class GetMyPlexAccountBadRequest extends RuntimeException {
    ...
    public GetMyPlexAccountBadRequest withErrors(List<GetMyPlexAccountErrors> errors) {
        Utils.checkNotNull(errors, "errors");
    ...
    public GetMyPlexAccountBadRequest withErrors(Optional<? extends List<GetMyPlexAccountErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetMyPlexAccountBadRequest withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetMyPlexAccountBadRequest withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetMyPlexAccountBadRequest other = (GetMyPlexAccountBadRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetMyPlexAccountBadRequest.class,
                "errors", errors,
    ...
    public final static class Builder {
        ...
        public GetMyPlexAccountBadRequest build() {

            return new GetMyPlexAccountBadRequest(
                errors, rawResponse);
        }
