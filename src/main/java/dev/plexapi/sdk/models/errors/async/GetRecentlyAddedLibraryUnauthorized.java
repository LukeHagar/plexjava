...
import dev.plexapi.sdk.models.errors.GetRecentlyAddedLibraryLibraryErrors;
...
public class GetRecentlyAddedLibraryUnauthorized extends RuntimeException {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetRecentlyAddedLibraryUnauthorized withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetRecentlyAddedLibraryUnauthorized withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
