...
public class GetPlaylistContentsPlaylistsErrors {
    ...
    public GetPlaylistContentsPlaylistsErrors withMessage(String message) {
        Utils.checkNotNull(message, "message");
        this.message = Optional.ofNullable(message);
        return this;
    }

    public GetPlaylistContentsPlaylistsErrors withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetPlaylistContentsPlaylistsErrors other = (GetPlaylistContentsPlaylistsErrors) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetPlaylistContentsPlaylistsErrors.class,
                "code", code,
                "message", message,
                "status", status);
    }
    ...
    public final static class Builder {
        ...
        public GetPlaylistContentsPlaylistsErrors build() {
