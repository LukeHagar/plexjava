...
public class GetMetadataChildrenLibraryErrors {
    ...
    public GetMetadataChildrenLibraryErrors withMessage(String message) {
        Utils.checkNotNull(message, "message");
        this.message = Optional.ofNullable(message);
        return this;
    }

    public GetMetadataChildrenLibraryErrors withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetMetadataChildrenLibraryErrors other = (GetMetadataChildrenLibraryErrors) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetMetadataChildrenLibraryErrors.class,
                "code", code,
                "message", message,
                "status", status);
    }
    ...
    public final static class Builder {
        ...
        public GetMetadataChildrenLibraryErrors build() {
            return new GetMetadataChildrenLibraryErrors(
                code,
                message,
                status);
        }
