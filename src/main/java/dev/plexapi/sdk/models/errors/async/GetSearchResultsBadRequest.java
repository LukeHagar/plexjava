...
import dev.plexapi.sdk.models.errors.GetSearchResultsErrors;
...
public class GetSearchResultsBadRequest extends RuntimeException {
    ...
    public GetSearchResultsBadRequest withErrors(List<GetSearchResultsErrors> errors) {
        Utils.checkNotNull(errors, "errors");
    ...
    public GetSearchResultsBadRequest withErrors(Optional<? extends List<GetSearchResultsErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetSearchResultsBadRequest withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetSearchResultsBadRequest withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSearchResultsBadRequest other = (GetSearchResultsBadRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSearchResultsBadRequest.class,
                "errors", errors,
    ...
    public final static class Builder {
        ...
        public GetSearchResultsBadRequest build() {

            return new GetSearchResultsBadRequest(
                errors, rawResponse);
        }
