...
public class GetServerCapabilitiesResponseBody extends RuntimeException {
    ...
    public GetServerCapabilitiesResponseBody withErrors(List<Errors> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = Optional.ofNullable(errors);
        return this;
    }
    
    public GetServerCapabilitiesResponseBody withErrors(Optional<? extends List<Errors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
