...
import dev.plexapi.sdk.models.errors.GetPlaylistsErrors;
...
public class GetPlaylistsBadRequest extends RuntimeException {
    ...
    public GetPlaylistsBadRequest withErrors(List<GetPlaylistsErrors> errors) {
        Utils.checkNotNull(errors, "errors");
    ...
    public GetPlaylistsBadRequest withErrors(Optional<? extends List<GetPlaylistsErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetPlaylistsBadRequest withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetPlaylistsBadRequest withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetPlaylistsBadRequest other = (GetPlaylistsBadRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetPlaylistsBadRequest.class,
                "errors", errors,
    ...
    public final static class Builder {
        ...
        public GetPlaylistsBadRequest build() {

            return new GetPlaylistsBadRequest(
                errors, rawResponse);
        }
