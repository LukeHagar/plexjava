...
public class GetSearchResultsSearchErrors {
    ...
    public GetSearchResultsSearchErrors withMessage(String message) {
        Utils.checkNotNull(message, "message");
        this.message = Optional.ofNullable(message);
        return this;
    }

    public GetSearchResultsSearchErrors withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSearchResultsSearchErrors other = (GetSearchResultsSearchErrors) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSearchResultsSearchErrors.class,
                "code", code,
                "message", message,
                "status", status);
    }
    ...
    public final static class Builder {
        ...
        public GetSearchResultsSearchErrors build() {
            return new GetSearchResultsSearchErrors(
                code,
                message,
                status);
        }
