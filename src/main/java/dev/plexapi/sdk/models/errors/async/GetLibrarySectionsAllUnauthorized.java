...
import dev.plexapi.sdk.models.errors.GetLibrarySectionsAllLibraryErrors;
...
public class GetLibrarySectionsAllUnauthorized extends RuntimeException {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetLibrarySectionsAllUnauthorized withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetLibrarySectionsAllUnauthorized withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
