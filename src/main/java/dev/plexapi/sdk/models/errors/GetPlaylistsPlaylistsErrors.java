...
public class GetPlaylistsPlaylistsErrors {
    ...
    public GetPlaylistsPlaylistsErrors withMessage(String message) {
        Utils.checkNotNull(message, "message");
    ...
    public GetPlaylistsPlaylistsErrors withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetPlaylistsPlaylistsErrors other = (GetPlaylistsPlaylistsErrors) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetPlaylistsPlaylistsErrors.class,
                "code", code,
                "message", message,
                "status", status);
    }
    ...
    public final static class Builder {
        ...
        public GetPlaylistsPlaylistsErrors build() {

            return new GetPlaylistsPlaylistsErrors(
                code, message, status);
        }
