...
public class GetRefreshLibraryMetadataLibraryErrors {
    ...
    public GetRefreshLibraryMetadataLibraryErrors withMessage(String message) {
        Utils.checkNotNull(message, "message");
        this.message = Optional.ofNullable(message);
        return this;
    }

    public GetRefreshLibraryMetadataLibraryErrors withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetRefreshLibraryMetadataLibraryErrors other = (GetRefreshLibraryMetadataLibraryErrors) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetRefreshLibraryMetadataLibraryErrors.class,
                "code", code,
                "message", message,
                "status", status);
    }
    ...
    public final static class Builder {
        ...
        public GetRefreshLibraryMetadataLibraryErrors build() {
            return new GetRefreshLibraryMetadataLibraryErrors(
                code,
                message,
                status);
        }
