...
public class GetSourceConnectionInformationErrors {
    ...
    public GetSourceConnectionInformationErrors withCode(Optional<Double> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
    ...
    public GetSourceConnectionInformationErrors withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
    ...
    public GetSourceConnectionInformationErrors withStatus(Optional<Double> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
