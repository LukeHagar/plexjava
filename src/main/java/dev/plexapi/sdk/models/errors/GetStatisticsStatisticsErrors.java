...
public class GetStatisticsStatisticsErrors {
    ...
    public GetStatisticsStatisticsErrors withMessage(String message) {
        Utils.checkNotNull(message, "message");
        this.message = Optional.ofNullable(message);
        return this;
    }

    public GetStatisticsStatisticsErrors withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetStatisticsStatisticsErrors other = (GetStatisticsStatisticsErrors) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetStatisticsStatisticsErrors.class,
                "code", code,
                "message", message,
                "status", status);
    }
    ...
    public final static class Builder {
        ...
        public GetStatisticsStatisticsErrors build() {
            return new GetStatisticsStatisticsErrors(
                code,
                message,
                status);
        }
