...
public class GetSessionHistorySessionsErrors {
    ...
    public GetSessionHistorySessionsErrors withMessage(String message) {
        Utils.checkNotNull(message, "message");
        this.message = Optional.ofNullable(message);
        return this;
    }

    public GetSessionHistorySessionsErrors withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSessionHistorySessionsErrors other = (GetSessionHistorySessionsErrors) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSessionHistorySessionsErrors.class,
                "code", code,
                "message", message,
                "status", status);
    }
    ...
    public final static class Builder {
        ...
        public GetSessionHistorySessionsErrors build() {
            return new GetSessionHistorySessionsErrors(
                code,
                message,
                status);
        }
