...
public class GetSessionHistoryErrors {
    ...
    public GetSessionHistoryErrors withCode(Optional<Double> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
    ...
    public GetSessionHistoryErrors withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
    ...
    public GetSessionHistoryErrors withStatus(Optional<Double> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
