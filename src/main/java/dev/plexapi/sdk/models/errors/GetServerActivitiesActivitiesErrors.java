...
public class GetServerActivitiesActivitiesErrors {
    ...
    public GetServerActivitiesActivitiesErrors withMessage(String message) {
        Utils.checkNotNull(message, "message");
        this.message = Optional.ofNullable(message);
        return this;
    }

    public GetServerActivitiesActivitiesErrors withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetServerActivitiesActivitiesErrors other = (GetServerActivitiesActivitiesErrors) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetServerActivitiesActivitiesErrors.class,
                "code", code,
                "message", message,
                "status", status);
    }
    ...
    public final static class Builder {
        ...
        public GetServerActivitiesActivitiesErrors build() {
            return new GetServerActivitiesActivitiesErrors(
                code,
                message,
                status);
        }
