...
import dev.plexapi.sdk.models.errors.GetResourcesStatisticsErrors;
...
public class GetResourcesStatisticsBadRequest extends RuntimeException {
    ...
    public GetResourcesStatisticsBadRequest withErrors(List<GetResourcesStatisticsErrors> errors) {
        Utils.checkNotNull(errors, "errors");
    ...
    public GetResourcesStatisticsBadRequest withErrors(Optional<? extends List<GetResourcesStatisticsErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetResourcesStatisticsBadRequest withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetResourcesStatisticsBadRequest withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetResourcesStatisticsBadRequest other = (GetResourcesStatisticsBadRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetResourcesStatisticsBadRequest.class,
                "errors", errors,
    ...
    public final static class Builder {
        ...
        public GetResourcesStatisticsBadRequest build() {

            return new GetResourcesStatisticsBadRequest(
                errors, rawResponse);
        }
