...
public class AddToPlayQueueRequest {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<BoolInt> next() {
        return (Optional<BoolInt>) next;
    }
     ...
     * Indicates the client accepts the indicated media types
     */
    public AddToPlayQueueRequest withAccepts(Accepts accepts) {
        Utils.checkNotNull(accepts, "accepts");
     ...
     * Indicates the client accepts the indicated media types
     */
    public AddToPlayQueueRequest withAccepts(Optional<? extends Accepts> accepts) {
        Utils.checkNotNull(accepts, "accepts");
        this.accepts = accepts;
        return this;
    }
     ...
     * An opaque identifier unique to the client
     */
    public AddToPlayQueueRequest withClientIdentifier(String clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
     ...
     * An opaque identifier unique to the client
     */
    public AddToPlayQueueRequest withClientIdentifier(Optional<String> clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
        this.clientIdentifier = clientIdentifier;
        return this;
    }
     ...
     * The name of the client product
     */
    public AddToPlayQueueRequest withProduct(Optional<String> product) {
        Utils.checkNotNull(product, "product");
        this.product = product;
        return this;
    }
     ...
     * The version of the client application
     */
    public AddToPlayQueueRequest withVersion(String version) {
        Utils.checkNotNull(version, "version");
     ...
     * The version of the client application
     */
    public AddToPlayQueueRequest withVersion(Optional<String> version) {
        Utils.checkNotNull(version, "version");
        this.version = version;
        return this;
    }
     ...
     * The platform of the client
     */
    public AddToPlayQueueRequest withPlatform(String platform) {
        Utils.checkNotNull(platform, "platform");
     ...
     * The platform of the client
     */
    public AddToPlayQueueRequest withPlatform(Optional<String> platform) {
        Utils.checkNotNull(platform, "platform");
        this.platform = platform;
        return this;
    }
     ...
     * The version of the platform
     */
    public AddToPlayQueueRequest withPlatformVersion(String platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
     ...
     * The version of the platform
     */
    public AddToPlayQueueRequest withPlatformVersion(Optional<String> platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
        this.platformVersion = platformVersion;
        return this;
    }
     ...
     * A relatively friendly name for the client device
     */
    public AddToPlayQueueRequest withDevice(String device) {
        Utils.checkNotNull(device, "device");
     ...
     * A relatively friendly name for the client device
     */
    public AddToPlayQueueRequest withDevice(Optional<String> device) {
        Utils.checkNotNull(device, "device");
        this.device = device;
        return this;
    }
     ...
     * A potentially less friendly identifier for the device model
     */
    public AddToPlayQueueRequest withModel(String model) {
        Utils.checkNotNull(model, "model");
     ...
     * A potentially less friendly identifier for the device model
     */
    public AddToPlayQueueRequest withModel(Optional<String> model) {
        Utils.checkNotNull(model, "model");
        this.model = model;
        return this;
    }
     ...
     * The device vendor
     */
    public AddToPlayQueueRequest withDeviceVendor(String deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
     ...
     * The device vendor
     */
    public AddToPlayQueueRequest withDeviceVendor(Optional<String> deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
        this.deviceVendor = deviceVendor;
        return this;
    }
     ...
     * A friendly name for the client
     */
    public AddToPlayQueueRequest withDeviceName(String deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
     ...
     * A friendly name for the client
     */
    public AddToPlayQueueRequest withDeviceName(Optional<String> deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
        this.deviceName = deviceName;
        return this;
    }
     ...
     * The marketplace on which the client application is distributed
     */
    public AddToPlayQueueRequest withMarketplace(String marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
     ...
     * The marketplace on which the client application is distributed
     */
    public AddToPlayQueueRequest withMarketplace(Optional<String> marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
        this.marketplace = marketplace;
        return this;
    }
     ...
     * The ID of the play queue.
     */
    public AddToPlayQueueRequest withPlayQueueId(long playQueueId) {
        Utils.checkNotNull(playQueueId, "playQueueId");
        this.playQueueId = playQueueId;
        return this;
    }
     ...
     * The content URI for what we're adding to the queue.
     */
    public AddToPlayQueueRequest withUri(String uri) {
        Utils.checkNotNull(uri, "uri");
     ...
     * The content URI for what we're adding to the queue.
     */
    public AddToPlayQueueRequest withUri(Optional<String> uri) {
        Utils.checkNotNull(uri, "uri");
        this.uri = uri;
        return this;
    }
     ...
     * The ID of the playlist to add to the playQueue.
     */
    public AddToPlayQueueRequest withPlaylistID(String playlistID) {
        Utils.checkNotNull(playlistID, "playlistID");
     ...
     * The ID of the playlist to add to the playQueue.
     */
    public AddToPlayQueueRequest withPlaylistID(Optional<String> playlistID) {
        Utils.checkNotNull(playlistID, "playlistID");
        this.playlistID = playlistID;
        return this;
    }
     ...
     * Play this item next (defaults to 0 - queueing at the end of manually queued items).
     */
    public AddToPlayQueueRequest withNext(BoolInt next) {
        Utils.checkNotNull(next, "next");
     ...
     * Play this item next (defaults to 0 - queueing at the end of manually queued items).
     */
    public AddToPlayQueueRequest withNext(Optional<? extends BoolInt> next) {
        Utils.checkNotNull(next, "next");
        this.next = next;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AddToPlayQueueRequest other = (AddToPlayQueueRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AddToPlayQueueRequest.class,
                "accepts", accepts,
    ...
    public final static class Builder {
         ...
         * The ID of the playlist to add to the playQueue.
         */
        public Builder playlistID(Optional<String> playlistID) {
            Utils.checkNotNull(playlistID, "playlistID");
            this.playlistID = playlistID;
            return this;
        }
         ...
         * Play this item next (defaults to 0 - queueing at the end of manually queued items).
         */
        public Builder next(BoolInt next) {
            Utils.checkNotNull(next, "next");
            this.next = Optional.ofNullable(next);
            return this;
        }
         ...
         * Play this item next (defaults to 0 - queueing at the end of manually queued items).
         */
        public Builder next(Optional<? extends BoolInt> next) {
            Utils.checkNotNull(next, "next");
            this.next = next;
            return this;
        }

        public AddToPlayQueueRequest build() {
            if (accepts == null) {
