...
public class GetTasksResponseBody {
    ...
    public GetTasksResponseBody withButlerTasks(ButlerTasks butlerTasks) {
        Utils.checkNotNull(butlerTasks, "butlerTasks");
    ...
    public GetTasksResponseBody withButlerTasks(Optional<? extends ButlerTasks> butlerTasks) {
        Utils.checkNotNull(butlerTasks, "butlerTasks");
        this.butlerTasks = butlerTasks;
        return this;
    }
