...
public class AddLineupDVR {
    ...
    public AddLineupDVR withDevice(List<Device> device) {
        Utils.checkNotNull(device, "device");
    ...
    public AddLineupDVR withDevice(Optional<? extends List<Device>> device) {
        Utils.checkNotNull(device, "device");
        this.device = device;
        return this;
    }

    public AddLineupDVR withKey(String key) {
        Utils.checkNotNull(key, "key");
    ...
    public AddLineupDVR withKey(Optional<String> key) {
        Utils.checkNotNull(key, "key");
        this.key = key;
        return this;
    }

    public AddLineupDVR withLanguage(String language) {
        Utils.checkNotNull(language, "language");
    ...
    public AddLineupDVR withLanguage(Optional<String> language) {
        Utils.checkNotNull(language, "language");
        this.language = language;
        return this;
    }

    public AddLineupDVR withLineup(String lineup) {
        Utils.checkNotNull(lineup, "lineup");
    ...
    public AddLineupDVR withLineup(Optional<String> lineup) {
        Utils.checkNotNull(lineup, "lineup");
        this.lineup = lineup;
        return this;
    }

    public AddLineupDVR withUuid(String uuid) {
        Utils.checkNotNull(uuid, "uuid");
    ...
    public AddLineupDVR withUuid(Optional<String> uuid) {
        Utils.checkNotNull(uuid, "uuid");
        this.uuid = uuid;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AddLineupDVR other = (AddLineupDVR) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AddLineupDVR.class,
                "device", device,
                "key", key,
                "language", language,
                "lineup", lineup,
    ...
    public final static class Builder {
        ...
        public AddLineupDVR build() {

            return new AddLineupDVR(
                device, key, language,
                lineup, uuid);
        }
