...
public class Dvr {
    ...
    public Dvr withDevice(List<Device> device) {
        Utils.checkNotNull(device, "device");
    ...
    public Dvr withDevice(Optional<? extends List<Device>> device) {
        Utils.checkNotNull(device, "device");
        this.device = device;
        return this;
    }

    public Dvr withKey(String key) {
        Utils.checkNotNull(key, "key");
    ...
    public Dvr withKey(Optional<String> key) {
        Utils.checkNotNull(key, "key");
        this.key = key;
        return this;
    }

    public Dvr withLanguage(String language) {
        Utils.checkNotNull(language, "language");
    ...
    public Dvr withLanguage(Optional<String> language) {
        Utils.checkNotNull(language, "language");
        this.language = language;
        return this;
    }

    public Dvr withLineup(String lineup) {
        Utils.checkNotNull(lineup, "lineup");
    ...
    public Dvr withLineup(Optional<String> lineup) {
        Utils.checkNotNull(lineup, "lineup");
        this.lineup = lineup;
        return this;
    }

    public Dvr withUuid(String uuid) {
        Utils.checkNotNull(uuid, "uuid");
    ...
    public Dvr withUuid(Optional<String> uuid) {
        Utils.checkNotNull(uuid, "uuid");
        this.uuid = uuid;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Dvr.class,
                "device", device,
                "key", key,
                "language", language,
                "lineup", lineup,
