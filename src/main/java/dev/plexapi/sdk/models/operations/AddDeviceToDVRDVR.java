...
public class AddDeviceToDVRDVR {
    ...
    public AddDeviceToDVRDVR withDevice(List<Device> device) {
        Utils.checkNotNull(device, "device");
    ...
    public AddDeviceToDVRDVR withDevice(Optional<? extends List<Device>> device) {
        Utils.checkNotNull(device, "device");
        this.device = device;
        return this;
    }

    public AddDeviceToDVRDVR withKey(String key) {
        Utils.checkNotNull(key, "key");
    ...
    public AddDeviceToDVRDVR withKey(Optional<String> key) {
        Utils.checkNotNull(key, "key");
        this.key = key;
        return this;
    }

    public AddDeviceToDVRDVR withLanguage(String language) {
        Utils.checkNotNull(language, "language");
    ...
    public AddDeviceToDVRDVR withLanguage(Optional<String> language) {
        Utils.checkNotNull(language, "language");
        this.language = language;
        return this;
    }

    public AddDeviceToDVRDVR withLineup(String lineup) {
        Utils.checkNotNull(lineup, "lineup");
    ...
    public AddDeviceToDVRDVR withLineup(Optional<String> lineup) {
        Utils.checkNotNull(lineup, "lineup");
        this.lineup = lineup;
        return this;
    }

    public AddDeviceToDVRDVR withUuid(String uuid) {
        Utils.checkNotNull(uuid, "uuid");
    ...
    public AddDeviceToDVRDVR withUuid(Optional<String> uuid) {
        Utils.checkNotNull(uuid, "uuid");
        this.uuid = uuid;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AddDeviceToDVRDVR other = (AddDeviceToDVRDVR) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AddDeviceToDVRDVR.class,
                "device", device,
                "key", key,
                "language", language,
                "lineup", lineup,
    ...
    public final static class Builder {
        ...
        public AddDeviceToDVRDVR build() {

            return new AddDeviceToDVRDVR(
                device, key, language,
                lineup, uuid);
        }
