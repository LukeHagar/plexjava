...
public class GetCountriesLineupsResponse implements Response {
    /**
    ...
    @JsonCreator
    public GetCountriesLineupsResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public GetCountriesLineupsResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetCountriesLineupsResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetCountriesLineupsResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public GetCountriesLineupsResponse withMediaContainerWithLineup(MediaContainerWithLineup mediaContainerWithLineup) {
        Utils.checkNotNull(mediaContainerWithLineup, "mediaContainerWithLineup");
     ...
     * OK
     */
    public GetCountriesLineupsResponse withMediaContainerWithLineup(Optional<? extends MediaContainerWithLineup> mediaContainerWithLineup) {
        Utils.checkNotNull(mediaContainerWithLineup, "mediaContainerWithLineup");
        this.mediaContainerWithLineup = mediaContainerWithLineup;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCountriesLineupsResponse other = (GetCountriesLineupsResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCountriesLineupsResponse.class,
    ...
    public final static class Builder {
        ...
        public GetCountriesLineupsResponse build() {

            return new GetCountriesLineupsResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithLineup);
        }
