...
import dev.plexapi.sdk.models.shared.Hub;
...
public class GetContinueWatchingMediaContainer {
    ...
    @JsonCreator
    public GetContinueWatchingMediaContainer(
    ...
    public GetContinueWatchingMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public GetContinueWatchingMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * The offset of where this container page starts among the total objects available. Also provided in the `X-Plex-Container-Start` header.
     */
    public GetContinueWatchingMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * The offset of where this container page starts among the total objects available. Also provided in the `X-Plex-Container-Start` header.
     */
    public GetContinueWatchingMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public GetContinueWatchingMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public GetContinueWatchingMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public GetContinueWatchingMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public GetContinueWatchingMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }

    public GetContinueWatchingMediaContainer withHub(List<Hub> hub) {
        Utils.checkNotNull(hub, "hub");
    ...
    public GetContinueWatchingMediaContainer withHub(Optional<? extends List<Hub>> hub) {
        Utils.checkNotNull(hub, "hub");
        this.hub = hub;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetContinueWatchingMediaContainer other = (GetContinueWatchingMediaContainer) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetContinueWatchingMediaContainer.class,
    ...
    public final static class Builder {
        ...
        public GetContinueWatchingMediaContainer build() {

            return new GetContinueWatchingMediaContainer(
                identifier, offset, size,
                totalSize, hub);
        }
