...
public class SetDVRPreferencesDVR {
    ...
    public SetDVRPreferencesDVR withDevice(List<Device> device) {
        Utils.checkNotNull(device, "device");
    ...
    public SetDVRPreferencesDVR withDevice(Optional<? extends List<Device>> device) {
        Utils.checkNotNull(device, "device");
        this.device = device;
        return this;
    }

    public SetDVRPreferencesDVR withKey(String key) {
        Utils.checkNotNull(key, "key");
    ...
    public SetDVRPreferencesDVR withKey(Optional<String> key) {
        Utils.checkNotNull(key, "key");
        this.key = key;
        return this;
    }

    public SetDVRPreferencesDVR withLanguage(String language) {
        Utils.checkNotNull(language, "language");
    ...
    public SetDVRPreferencesDVR withLanguage(Optional<String> language) {
        Utils.checkNotNull(language, "language");
        this.language = language;
        return this;
    }

    public SetDVRPreferencesDVR withLineup(String lineup) {
        Utils.checkNotNull(lineup, "lineup");
    ...
    public SetDVRPreferencesDVR withLineup(Optional<String> lineup) {
        Utils.checkNotNull(lineup, "lineup");
        this.lineup = lineup;
        return this;
    }

    public SetDVRPreferencesDVR withUuid(String uuid) {
        Utils.checkNotNull(uuid, "uuid");
    ...
    public SetDVRPreferencesDVR withUuid(Optional<String> uuid) {
        Utils.checkNotNull(uuid, "uuid");
        this.uuid = uuid;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SetDVRPreferencesDVR other = (SetDVRPreferencesDVR) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SetDVRPreferencesDVR.class,
                "device", device,
                "key", key,
                "language", language,
                "lineup", lineup,
    ...
    public final static class Builder {
        ...
        public SetDVRPreferencesDVR build() {

            return new SetDVRPreferencesDVR(
                device, key, language,
                lineup, uuid);
        }
