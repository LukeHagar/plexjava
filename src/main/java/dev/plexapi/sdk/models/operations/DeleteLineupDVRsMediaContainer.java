...
public class DeleteLineupDVRsMediaContainer {
    ...
    @JsonCreator
    public DeleteLineupDVRsMediaContainer(
    ...
    public DeleteLineupDVRsMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public DeleteLineupDVRsMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * The offset of where this container page starts among the total objects available. Also provided in the `X-Plex-Container-Start` header.
     */
    public DeleteLineupDVRsMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * The offset of where this container page starts among the total objects available. Also provided in the `X-Plex-Container-Start` header.
     */
    public DeleteLineupDVRsMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public DeleteLineupDVRsMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public DeleteLineupDVRsMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public DeleteLineupDVRsMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public DeleteLineupDVRsMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }
     ...
     * A status indicator. If present and non-zero, indicates an error
     */
    public DeleteLineupDVRsMediaContainer withStatus(long status) {
        Utils.checkNotNull(status, "status");
     ...
     * A status indicator. If present and non-zero, indicates an error
     */
    public DeleteLineupDVRsMediaContainer withStatus(Optional<Long> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeleteLineupDVRsMediaContainer other = (DeleteLineupDVRsMediaContainer) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DeleteLineupDVRsMediaContainer.class,
    ...
    public final static class Builder {
        ...
        public DeleteLineupDVRsMediaContainer build() {

            return new DeleteLineupDVRsMediaContainer(
                identifier, offset, size,
                totalSize, status);
        }
