...
public class GetSourceConnectionInformationRequest {
    ...
    public GetSourceConnectionInformationRequest(
            ...
            String source,
            Optional<? extends BoolInt> refresh) {
        ...
        Utils.checkNotNull(refresh, "refresh");
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<BoolInt> refresh() {
        return (Optional<BoolInt>) refresh;
    }
     ...
     * Indicates the client accepts the indicated media types
     */
    public GetSourceConnectionInformationRequest withAccepts(Accepts accepts) {
        Utils.checkNotNull(accepts, "accepts");
     ...
     * Indicates the client accepts the indicated media types
     */
    public GetSourceConnectionInformationRequest withAccepts(Optional<? extends Accepts> accepts) {
        Utils.checkNotNull(accepts, "accepts");
        this.accepts = accepts;
        return this;
    }
     ...
     * An opaque identifier unique to the client
     */
    public GetSourceConnectionInformationRequest withClientIdentifier(String clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
     ...
     * An opaque identifier unique to the client
     */
    public GetSourceConnectionInformationRequest withClientIdentifier(Optional<String> clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
        this.clientIdentifier = clientIdentifier;
        return this;
    }
     ...
     * The name of the client product
     */
    public GetSourceConnectionInformationRequest withProduct(Optional<String> product) {
        Utils.checkNotNull(product, "product");
        this.product = product;
        return this;
    }
     ...
     * The version of the client application
     */
    public GetSourceConnectionInformationRequest withVersion(String version) {
        Utils.checkNotNull(version, "version");
     ...
     * The version of the client application
     */
    public GetSourceConnectionInformationRequest withVersion(Optional<String> version) {
        Utils.checkNotNull(version, "version");
        this.version = version;
        return this;
    }
     ...
     * The platform of the client
     */
    public GetSourceConnectionInformationRequest withPlatform(String platform) {
        Utils.checkNotNull(platform, "platform");
     ...
     * The platform of the client
     */
    public GetSourceConnectionInformationRequest withPlatform(Optional<String> platform) {
        Utils.checkNotNull(platform, "platform");
        this.platform = platform;
        return this;
    }
     ...
     * The version of the platform
     */
    public GetSourceConnectionInformationRequest withPlatformVersion(String platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
     ...
     * The version of the platform
     */
    public GetSourceConnectionInformationRequest withPlatformVersion(Optional<String> platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
        this.platformVersion = platformVersion;
        return this;
    }
     ...
     * A relatively friendly name for the client device
     */
    public GetSourceConnectionInformationRequest withDevice(String device) {
        Utils.checkNotNull(device, "device");
     ...
     * A relatively friendly name for the client device
     */
    public GetSourceConnectionInformationRequest withDevice(Optional<String> device) {
        Utils.checkNotNull(device, "device");
        this.device = device;
        return this;
    }
     ...
     * A potentially less friendly identifier for the device model
     */
    public GetSourceConnectionInformationRequest withModel(String model) {
        Utils.checkNotNull(model, "model");
     ...
     * A potentially less friendly identifier for the device model
     */
    public GetSourceConnectionInformationRequest withModel(Optional<String> model) {
        Utils.checkNotNull(model, "model");
        this.model = model;
        return this;
    }
     ...
     * The device vendor
     */
    public GetSourceConnectionInformationRequest withDeviceVendor(String deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
     ...
     * The device vendor
     */
    public GetSourceConnectionInformationRequest withDeviceVendor(Optional<String> deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
        this.deviceVendor = deviceVendor;
        return this;
    }
     ...
     * A friendly name for the client
     */
    public GetSourceConnectionInformationRequest withDeviceName(String deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
     ...
     * A friendly name for the client
     */
    public GetSourceConnectionInformationRequest withDeviceName(Optional<String> deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
        this.deviceName = deviceName;
        return this;
    }
     ...
     * The marketplace on which the client application is distributed
     */
    public GetSourceConnectionInformationRequest withMarketplace(String marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
     ...
     * The marketplace on which the client application is distributed
     */
    public GetSourceConnectionInformationRequest withMarketplace(Optional<String> marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
        this.marketplace = marketplace;
        return this;
    }
     ...
     * Force refresh
     */
    public GetSourceConnectionInformationRequest withRefresh(BoolInt refresh) {
        Utils.checkNotNull(refresh, "refresh");
     ...
     * Force refresh
     */
    public GetSourceConnectionInformationRequest withRefresh(Optional<? extends BoolInt> refresh) {
        Utils.checkNotNull(refresh, "refresh");
        this.refresh = refresh;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Utils.enhancedDeepEquals(this.refresh, other.refresh);
    }
    ...
    public final static class Builder {
         ...
         * Force refresh
         */
        public Builder refresh(BoolInt refresh) {
            Utils.checkNotNull(refresh, "refresh");
            this.refresh = Optional.ofNullable(refresh);
            return this;
        }
         ...
         * Force refresh
         */
        public Builder refresh(Optional<? extends BoolInt> refresh) {
            Utils.checkNotNull(refresh, "refresh");
            this.refresh = refresh;
            return this;
        }
