...
public class GetSectionHubsMediaContainer {
    ...
    @JsonCreator
    public GetSectionHubsMediaContainer(
    ...
    public GetSectionHubsMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public GetSectionHubsMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * The offset of where this container page starts among the total objects available. Also provided in the `X-Plex-Container-Start` header.
     */
    public GetSectionHubsMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * The offset of where this container page starts among the total objects available. Also provided in the `X-Plex-Container-Start` header.
     */
    public GetSectionHubsMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public GetSectionHubsMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public GetSectionHubsMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public GetSectionHubsMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public GetSectionHubsMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }

    public GetSectionHubsMediaContainer withHub(List<Hub> hub) {
        Utils.checkNotNull(hub, "hub");
    ...
    public GetSectionHubsMediaContainer withHub(Optional<? extends List<Hub>> hub) {
        Utils.checkNotNull(hub, "hub");
        this.hub = hub;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSectionHubsMediaContainer other = (GetSectionHubsMediaContainer) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSectionHubsMediaContainer.class,
    ...
    public final static class Builder {
        ...
        public GetSectionHubsMediaContainer build() {

            return new GetSectionHubsMediaContainer(
                identifier, offset, size,
                totalSize, hub);
        }
