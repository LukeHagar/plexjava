...
public class VoiceSearchHubsMediaContainer {
    ...
    @JsonCreator
    public VoiceSearchHubsMediaContainer(
    ...
    public VoiceSearchHubsMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public VoiceSearchHubsMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * The offset of where this container page starts among the total objects available. Also provided in the `X-Plex-Container-Start` header.
     */
    public VoiceSearchHubsMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * The offset of where this container page starts among the total objects available. Also provided in the `X-Plex-Container-Start` header.
     */
    public VoiceSearchHubsMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public VoiceSearchHubsMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public VoiceSearchHubsMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public VoiceSearchHubsMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public VoiceSearchHubsMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }

    public VoiceSearchHubsMediaContainer withHub(List<Hub> hub) {
        Utils.checkNotNull(hub, "hub");
    ...
    public VoiceSearchHubsMediaContainer withHub(Optional<? extends List<Hub>> hub) {
        Utils.checkNotNull(hub, "hub");
        this.hub = hub;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        VoiceSearchHubsMediaContainer other = (VoiceSearchHubsMediaContainer) o;
        return 
    ...
    public String toString() {
        return Utils.toString(VoiceSearchHubsMediaContainer.class,
    ...
    public final static class Builder {
        ...
        public VoiceSearchHubsMediaContainer build() {

            return new VoiceSearchHubsMediaContainer(
                identifier, offset, size,
                totalSize, hub);
        }
