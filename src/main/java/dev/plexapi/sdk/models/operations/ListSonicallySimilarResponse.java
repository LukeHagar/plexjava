...
public class ListSonicallySimilarResponse implements Response {
    /**
    ...
    @JsonCreator
    public ListSonicallySimilarResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public ListSonicallySimilarResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public ListSonicallySimilarResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListSonicallySimilarResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public ListSonicallySimilarResponse withMediaContainerWithMetadata(MediaContainerWithMetadata mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
     ...
     * OK
     */
    public ListSonicallySimilarResponse withMediaContainerWithMetadata(Optional<? extends MediaContainerWithMetadata> mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
        this.mediaContainerWithMetadata = mediaContainerWithMetadata;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListSonicallySimilarResponse other = (ListSonicallySimilarResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListSonicallySimilarResponse.class,
    ...
    public final static class Builder {
        ...
        public ListSonicallySimilarResponse build() {

            return new ListSonicallySimilarResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithMetadata);
        }
