...
public class ListPersonMediaResponse implements Response {
    /**
    ...
    @JsonCreator
    public ListPersonMediaResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public ListPersonMediaResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public ListPersonMediaResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListPersonMediaResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public ListPersonMediaResponse withMediaContainerWithMetadata(MediaContainerWithMetadata mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
     ...
     * OK
     */
    public ListPersonMediaResponse withMediaContainerWithMetadata(Optional<? extends MediaContainerWithMetadata> mediaContainerWithMetadata) {
        Utils.checkNotNull(mediaContainerWithMetadata, "mediaContainerWithMetadata");
        this.mediaContainerWithMetadata = mediaContainerWithMetadata;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListPersonMediaResponse other = (ListPersonMediaResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListPersonMediaResponse.class,
    ...
    public final static class Builder {
        ...
        public ListPersonMediaResponse build() {

            return new ListPersonMediaResponse(
                contentType, statusCode, rawResponse,
                mediaContainerWithMetadata);
        }
