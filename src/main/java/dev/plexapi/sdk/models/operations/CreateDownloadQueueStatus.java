...
public enum CreateDownloadQueueStatus {
    ...
    CreateDownloadQueueStatus(String value) {
        this.value = value;
    }
    ...
    public static Optional<CreateDownloadQueueStatus> fromValue(String value) {
        for (CreateDownloadQueueStatus o: CreateDownloadQueueStatus.values()) {
