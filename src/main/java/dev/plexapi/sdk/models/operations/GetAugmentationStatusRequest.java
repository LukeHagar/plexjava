...
public class GetAugmentationStatusRequest {
    ...
    public GetAugmentationStatusRequest(
            ...
            Optional<? extends BoolInt> wait_) {
        ...
        Utils.checkNotNull(augmentationId, "augmentationId");
    ...
    public GetAugmentationStatusRequest(
        ...
        this(Optional.empty(), Optional.empty(), Optional.empty(),
            ...
            Optional.empty(), Optional.empty(), Optional.empty(),
            Optional.empty(), Optional.empty(), augmentationId,
            Optional.empty());
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<BoolInt> wait_() {
        return (Optional<BoolInt>) wait_;
    }
     ...
     * Indicates the client accepts the indicated media types
     */
    public GetAugmentationStatusRequest withAccepts(Accepts accepts) {
        Utils.checkNotNull(accepts, "accepts");
     ...
     * Indicates the client accepts the indicated media types
     */
    public GetAugmentationStatusRequest withAccepts(Optional<? extends Accepts> accepts) {
        Utils.checkNotNull(accepts, "accepts");
        this.accepts = accepts;
        return this;
    }
     ...
     * An opaque identifier unique to the client
     */
    public GetAugmentationStatusRequest withClientIdentifier(String clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
     ...
     * An opaque identifier unique to the client
     */
    public GetAugmentationStatusRequest withClientIdentifier(Optional<String> clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
        this.clientIdentifier = clientIdentifier;
        return this;
    }
     ...
     * The name of the client product
     */
    public GetAugmentationStatusRequest withProduct(String product) {
        Utils.checkNotNull(product, "product");
     ...
     * The name of the client product
     */
    public GetAugmentationStatusRequest withProduct(Optional<String> product) {
        Utils.checkNotNull(product, "product");
        this.product = product;
        return this;
    }
     ...
     * The version of the client application
     */
    public GetAugmentationStatusRequest withVersion(String version) {
        Utils.checkNotNull(version, "version");
     ...
     * The version of the client application
     */
    public GetAugmentationStatusRequest withVersion(Optional<String> version) {
        Utils.checkNotNull(version, "version");
        this.version = version;
        return this;
    }
     ...
     * The platform of the client
     */
    public GetAugmentationStatusRequest withPlatform(String platform) {
        Utils.checkNotNull(platform, "platform");
     ...
     * The platform of the client
     */
    public GetAugmentationStatusRequest withPlatform(Optional<String> platform) {
        Utils.checkNotNull(platform, "platform");
        this.platform = platform;
        return this;
    }
     ...
     * The version of the platform
     */
    public GetAugmentationStatusRequest withPlatformVersion(String platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
     ...
     * The version of the platform
     */
    public GetAugmentationStatusRequest withPlatformVersion(Optional<String> platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
        this.platformVersion = platformVersion;
        return this;
    }
     ...
     * A relatively friendly name for the client device
     */
    public GetAugmentationStatusRequest withDevice(String device) {
        Utils.checkNotNull(device, "device");
     ...
     * A relatively friendly name for the client device
     */
    public GetAugmentationStatusRequest withDevice(Optional<String> device) {
        Utils.checkNotNull(device, "device");
        this.device = device;
        return this;
    }
     ...
     * A potentially less friendly identifier for the device model
     */
    public GetAugmentationStatusRequest withModel(String model) {
        Utils.checkNotNull(model, "model");
     ...
     * A potentially less friendly identifier for the device model
     */
    public GetAugmentationStatusRequest withModel(Optional<String> model) {
        Utils.checkNotNull(model, "model");
        this.model = model;
        return this;
    }
     ...
     * The device vendor
     */
    public GetAugmentationStatusRequest withDeviceVendor(String deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
     ...
     * The device vendor
     */
    public GetAugmentationStatusRequest withDeviceVendor(Optional<String> deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
        this.deviceVendor = deviceVendor;
        return this;
    }
     ...
     * A friendly name for the client
     */
    public GetAugmentationStatusRequest withDeviceName(String deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
     ...
     * A friendly name for the client
     */
    public GetAugmentationStatusRequest withDeviceName(Optional<String> deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
        this.deviceName = deviceName;
        return this;
    }
     ...
     * The marketplace on which the client application is distributed
     */
    public GetAugmentationStatusRequest withMarketplace(String marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
     ...
     * The marketplace on which the client application is distributed
     */
    public GetAugmentationStatusRequest withMarketplace(Optional<String> marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
        this.marketplace = marketplace;
        return this;
    }
     ...
     * The id of the augmentation
     */
    public GetAugmentationStatusRequest withAugmentationId(String augmentationId) {
        Utils.checkNotNull(augmentationId, "augmentationId");
        this.augmentationId = augmentationId;
        return this;
    }
     ...
     * Wait for augmentation completion before returning
     */
    public GetAugmentationStatusRequest withWait(BoolInt wait_) {
        Utils.checkNotNull(wait_, "wait_");
     ...
     * Wait for augmentation completion before returning
     */
    public GetAugmentationStatusRequest withWait(Optional<? extends BoolInt> wait_) {
        Utils.checkNotNull(wait_, "wait_");
        this.wait_ = wait_;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetAugmentationStatusRequest other = (GetAugmentationStatusRequest) o;
        return 
            ...
            Utils.enhancedDeepEquals(this.augmentationId, other.augmentationId) &&
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            deviceName, marketplace, augmentationId,
            wait_);
    }
    
    @Override
    public String toString() {
        return Utils.toString(GetAugmentationStatusRequest.class,
                "accepts", accepts,
    ...
    public final static class Builder {
         ...
         * The id of the augmentation
         */
        public Builder augmentationId(String augmentationId) {
            Utils.checkNotNull(augmentationId, "augmentationId");
            this.augmentationId = augmentationId;
            return this;
        }
         ...
         * Wait for augmentation completion before returning
         */
        public Builder wait_(BoolInt wait_) {
            Utils.checkNotNull(wait_, "wait_");
            this.wait_ = Optional.ofNullable(wait_);
            return this;
        }
         ...
         * Wait for augmentation completion before returning
         */
        public Builder wait_(Optional<? extends BoolInt> wait_) {
            Utils.checkNotNull(wait_, "wait_");
            this.wait_ = wait_;
            return this;
        }

        public GetAugmentationStatusRequest build() {
            if (accepts == null) {
