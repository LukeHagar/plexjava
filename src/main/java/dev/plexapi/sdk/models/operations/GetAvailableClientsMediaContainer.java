...
public class GetAvailableClientsMediaContainer {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("Server")
    private Optional<? extends List<Server>> server;

    @JsonCreator
    public GetAvailableClientsMediaContainer(
            @JsonProperty("size") Optional<Double> size,
            @JsonProperty("Server") Optional<? extends List<Server>> server) {
    ...
    @JsonIgnore
    public Optional<List<Server>> server() {
        return (Optional<List<Server>>) server;
    }
    ...
    public GetAvailableClientsMediaContainer withSize(Optional<Double> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }

    public GetAvailableClientsMediaContainer withServer(List<Server> server) {
        Utils.checkNotNull(server, "server");
    ...
    public GetAvailableClientsMediaContainer withServer(Optional<? extends List<Server>> server) {
        Utils.checkNotNull(server, "server");
        this.server = server;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends List<Server>> server = Optional.empty();
        ...
        public Builder server(Optional<? extends List<Server>> server) {
            Utils.checkNotNull(server, "server");
            this.server = server;
            return this;
        }
