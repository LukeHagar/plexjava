...
public class GetRelatedItemsMediaContainer {
    ...
    @JsonCreator
    public GetRelatedItemsMediaContainer(
    ...
    public GetRelatedItemsMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public GetRelatedItemsMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * The offset of where this container page starts among the total objects available. Also provided in the `X-Plex-Container-Start` header.
     */
    public GetRelatedItemsMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * The offset of where this container page starts among the total objects available. Also provided in the `X-Plex-Container-Start` header.
     */
    public GetRelatedItemsMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public GetRelatedItemsMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public GetRelatedItemsMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public GetRelatedItemsMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public GetRelatedItemsMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }

    public GetRelatedItemsMediaContainer withHub(List<Hub> hub) {
        Utils.checkNotNull(hub, "hub");
    ...
    public GetRelatedItemsMediaContainer withHub(Optional<? extends List<Hub>> hub) {
        Utils.checkNotNull(hub, "hub");
        this.hub = hub;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetRelatedItemsMediaContainer other = (GetRelatedItemsMediaContainer) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetRelatedItemsMediaContainer.class,
    ...
    public final static class Builder {
        ...
        public GetRelatedItemsMediaContainer build() {

            return new GetRelatedItemsMediaContainer(
                identifier, offset, size,
                totalSize, hub);
        }
