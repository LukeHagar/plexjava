...
public class GetStreamLoudnessRequest {
    ...
    private Optional<Long> subsample;

    @JsonCreator
    public GetStreamLoudnessRequest(
        ...
        Utils.checkNotNull(subsample, "subsample");
     ...
     */
    @JsonIgnore
    public Optional<Long> subsample() {
        return subsample;
    }
     ...
     * Indicates the client accepts the indicated media types
     */
    public GetStreamLoudnessRequest withAccepts(Accepts accepts) {
        Utils.checkNotNull(accepts, "accepts");
     ...
     * Indicates the client accepts the indicated media types
     */
    public GetStreamLoudnessRequest withAccepts(Optional<? extends Accepts> accepts) {
        Utils.checkNotNull(accepts, "accepts");
        this.accepts = accepts;
        return this;
    }
     ...
     * An opaque identifier unique to the client
     */
    public GetStreamLoudnessRequest withClientIdentifier(String clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
     ...
     * An opaque identifier unique to the client
     */
    public GetStreamLoudnessRequest withClientIdentifier(Optional<String> clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
        this.clientIdentifier = clientIdentifier;
        return this;
    }
     ...
     * The name of the client product
     */
    public GetStreamLoudnessRequest withProduct(Optional<String> product) {
        Utils.checkNotNull(product, "product");
        this.product = product;
        return this;
    }
     ...
     * The version of the client application
     */
    public GetStreamLoudnessRequest withVersion(String version) {
        Utils.checkNotNull(version, "version");
     ...
     * The version of the client application
     */
    public GetStreamLoudnessRequest withVersion(Optional<String> version) {
        Utils.checkNotNull(version, "version");
        this.version = version;
        return this;
    }
     ...
     * The platform of the client
     */
    public GetStreamLoudnessRequest withPlatform(String platform) {
        Utils.checkNotNull(platform, "platform");
     ...
     * The platform of the client
     */
    public GetStreamLoudnessRequest withPlatform(Optional<String> platform) {
        Utils.checkNotNull(platform, "platform");
        this.platform = platform;
        return this;
    }
     ...
     * The version of the platform
     */
    public GetStreamLoudnessRequest withPlatformVersion(String platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
     ...
     * The version of the platform
     */
    public GetStreamLoudnessRequest withPlatformVersion(Optional<String> platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
        this.platformVersion = platformVersion;
        return this;
    }
     ...
     * A relatively friendly name for the client device
     */
    public GetStreamLoudnessRequest withDevice(String device) {
        Utils.checkNotNull(device, "device");
     ...
     * A relatively friendly name for the client device
     */
    public GetStreamLoudnessRequest withDevice(Optional<String> device) {
        Utils.checkNotNull(device, "device");
        this.device = device;
        return this;
    }
     ...
     * A potentially less friendly identifier for the device model
     */
    public GetStreamLoudnessRequest withModel(String model) {
        Utils.checkNotNull(model, "model");
     ...
     * A potentially less friendly identifier for the device model
     */
    public GetStreamLoudnessRequest withModel(Optional<String> model) {
        Utils.checkNotNull(model, "model");
        this.model = model;
        return this;
    }
     ...
     * The device vendor
     */
    public GetStreamLoudnessRequest withDeviceVendor(String deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
     ...
     * The device vendor
     */
    public GetStreamLoudnessRequest withDeviceVendor(Optional<String> deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
        this.deviceVendor = deviceVendor;
        return this;
    }
     ...
     * A friendly name for the client
     */
    public GetStreamLoudnessRequest withDeviceName(String deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
     ...
     * A friendly name for the client
     */
    public GetStreamLoudnessRequest withDeviceName(Optional<String> deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
        this.deviceName = deviceName;
        return this;
    }
     ...
     * The marketplace on which the client application is distributed
     */
    public GetStreamLoudnessRequest withMarketplace(String marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
     ...
     * The marketplace on which the client application is distributed
     */
    public GetStreamLoudnessRequest withMarketplace(Optional<String> marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
        this.marketplace = marketplace;
        return this;
    }
     ...
     * The id of the stream
     */
    public GetStreamLoudnessRequest withStreamId(long streamId) {
        Utils.checkNotNull(streamId, "streamId");
        this.streamId = streamId;
        return this;
    }
     ...
     * Subsample result down to return only the provided number of samples
     */
    public GetStreamLoudnessRequest withSubsample(long subsample) {
        Utils.checkNotNull(subsample, "subsample");
        this.subsample = Optional.ofNullable(subsample);
        return this;
    }
     ...
     * Subsample result down to return only the provided number of samples
     */
    public GetStreamLoudnessRequest withSubsample(Optional<Long> subsample) {
        Utils.checkNotNull(subsample, "subsample");
        this.subsample = subsample;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetStreamLoudnessRequest other = (GetStreamLoudnessRequest) o;
        return 
            ...
            Utils.enhancedDeepEquals(this.subsample, other.subsample);
    }
    ...
    public String toString() {
        return Utils.toString(GetStreamLoudnessRequest.class,
                "accepts", accepts,
    ...
    public final static class Builder {
        ...
        private Optional<Long> subsample = Optional.empty();
         ...
         * Subsample result down to return only the provided number of samples
         */
        public Builder subsample(long subsample) {
            Utils.checkNotNull(subsample, "subsample");
            this.subsample = Optional.ofNullable(subsample);
            return this;
        }
         ...
         * Subsample result down to return only the provided number of samples
         */
        public Builder subsample(Optional<Long> subsample) {
            Utils.checkNotNull(subsample, "subsample");
            this.subsample = subsample;
            return this;
        }

        public GetStreamLoudnessRequest build() {
            if (accepts == null) {
                accepts = _SINGLETON_VALUE_Accepts.value();
            }

            return new GetStreamLoudnessRequest(
                accepts, clientIdentifier, product,
                version, platform, platformVersion,
                device, model, deviceVendor,
                deviceName, marketplace, streamId,
