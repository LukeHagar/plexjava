...
public class GetSectionFiltersMediaContainer {
    ...
    @JsonCreator
    public GetSectionFiltersMediaContainer(
    ...
    public GetSectionFiltersMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public GetSectionFiltersMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * The offset of where this container page starts among the total objects available. Also provided in the `X-Plex-Container-Start` header.
     */
    public GetSectionFiltersMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * The offset of where this container page starts among the total objects available. Also provided in the `X-Plex-Container-Start` header.
     */
    public GetSectionFiltersMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public GetSectionFiltersMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public GetSectionFiltersMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public GetSectionFiltersMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public GetSectionFiltersMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }

    public GetSectionFiltersMediaContainer withDirectory(List<Directory> directory) {
        Utils.checkNotNull(directory, "directory");
    ...
    public GetSectionFiltersMediaContainer withDirectory(Optional<? extends List<Directory>> directory) {
        Utils.checkNotNull(directory, "directory");
        this.directory = directory;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSectionFiltersMediaContainer other = (GetSectionFiltersMediaContainer) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetSectionFiltersMediaContainer.class,
    ...
    public final static class Builder {
        ...
        public GetSectionFiltersMediaContainer build() {

            return new GetSectionFiltersMediaContainer(
                identifier, offset, size,
                totalSize, directory);
        }
