...
public class MovePlayQueueItemRequest {
    ...
    public MovePlayQueueItemRequest(
        ...
        this(Optional.empty(), Optional.empty(), Optional.empty(),
            ...
            playQueueItemId, Optional.empty());
    }
     ...
     * Indicates the client accepts the indicated media types
     */
    public MovePlayQueueItemRequest withAccepts(Accepts accepts) {
        Utils.checkNotNull(accepts, "accepts");
     ...
     * Indicates the client accepts the indicated media types
     */
    public MovePlayQueueItemRequest withAccepts(Optional<? extends Accepts> accepts) {
        Utils.checkNotNull(accepts, "accepts");
        this.accepts = accepts;
        return this;
    }
     ...
     * An opaque identifier unique to the client
     */
    public MovePlayQueueItemRequest withClientIdentifier(String clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
     ...
     * An opaque identifier unique to the client
     */
    public MovePlayQueueItemRequest withClientIdentifier(Optional<String> clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
        this.clientIdentifier = clientIdentifier;
        return this;
    }
     ...
     * The name of the client product
     */
    public MovePlayQueueItemRequest withProduct(String product) {
        Utils.checkNotNull(product, "product");
     ...
     * The name of the client product
     */
    public MovePlayQueueItemRequest withProduct(Optional<String> product) {
        Utils.checkNotNull(product, "product");
        this.product = product;
        return this;
    }
     ...
     * The version of the client application
     */
    public MovePlayQueueItemRequest withVersion(String version) {
        Utils.checkNotNull(version, "version");
     ...
     * The version of the client application
     */
    public MovePlayQueueItemRequest withVersion(Optional<String> version) {
        Utils.checkNotNull(version, "version");
        this.version = version;
        return this;
    }
     ...
     * The platform of the client
     */
    public MovePlayQueueItemRequest withPlatform(String platform) {
        Utils.checkNotNull(platform, "platform");
     ...
     * The platform of the client
     */
    public MovePlayQueueItemRequest withPlatform(Optional<String> platform) {
        Utils.checkNotNull(platform, "platform");
        this.platform = platform;
        return this;
    }
     ...
     * The version of the platform
     */
    public MovePlayQueueItemRequest withPlatformVersion(String platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
     ...
     * The version of the platform
     */
    public MovePlayQueueItemRequest withPlatformVersion(Optional<String> platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
        this.platformVersion = platformVersion;
        return this;
    }
     ...
     * A relatively friendly name for the client device
     */
    public MovePlayQueueItemRequest withDevice(String device) {
        Utils.checkNotNull(device, "device");
     ...
     * A relatively friendly name for the client device
     */
    public MovePlayQueueItemRequest withDevice(Optional<String> device) {
        Utils.checkNotNull(device, "device");
        this.device = device;
        return this;
    }
     ...
     * A potentially less friendly identifier for the device model
     */
    public MovePlayQueueItemRequest withModel(String model) {
        Utils.checkNotNull(model, "model");
     ...
     * A potentially less friendly identifier for the device model
     */
    public MovePlayQueueItemRequest withModel(Optional<String> model) {
        Utils.checkNotNull(model, "model");
        this.model = model;
        return this;
    }
     ...
     * The device vendor
     */
    public MovePlayQueueItemRequest withDeviceVendor(String deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
     ...
     * The device vendor
     */
    public MovePlayQueueItemRequest withDeviceVendor(Optional<String> deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
        this.deviceVendor = deviceVendor;
        return this;
    }
     ...
     * A friendly name for the client
     */
    public MovePlayQueueItemRequest withDeviceName(String deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
     ...
     * A friendly name for the client
     */
    public MovePlayQueueItemRequest withDeviceName(Optional<String> deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
        this.deviceName = deviceName;
        return this;
    }
     ...
     * The marketplace on which the client application is distributed
     */
    public MovePlayQueueItemRequest withMarketplace(String marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
     ...
     * The marketplace on which the client application is distributed
     */
    public MovePlayQueueItemRequest withMarketplace(Optional<String> marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
        this.marketplace = marketplace;
        return this;
    }
     ...
     * The ID of the play queue.
     */
    public MovePlayQueueItemRequest withPlayQueueId(long playQueueId) {
        Utils.checkNotNull(playQueueId, "playQueueId");
        this.playQueueId = playQueueId;
        return this;
    }
     ...
     * The play queue item ID to delete.
     */
    public MovePlayQueueItemRequest withPlayQueueItemId(long playQueueItemId) {
        Utils.checkNotNull(playQueueItemId, "playQueueItemId");
        this.playQueueItemId = playQueueItemId;
        return this;
    }
     ...
     * The play queue item ID to insert the new item after. If not present, moves to the beginning.
     */
    public MovePlayQueueItemRequest withAfter(long after) {
        Utils.checkNotNull(after, "after");
     ...
     * The play queue item ID to insert the new item after. If not present, moves to the beginning.
     */
    public MovePlayQueueItemRequest withAfter(Optional<Long> after) {
        Utils.checkNotNull(after, "after");
        this.after = after;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MovePlayQueueItemRequest other = (MovePlayQueueItemRequest) o;
        return 
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            playQueueItemId, after);
    }
    
    @Override
    public String toString() {
        return Utils.toString(MovePlayQueueItemRequest.class,
                "accepts", accepts,
    ...
    public final static class Builder {
        ...
        public MovePlayQueueItemRequest build() {
            if (accepts == null) {
                accepts = _SINGLETON_VALUE_Accepts.value();
            }

            return new MovePlayQueueItemRequest(
                accepts, clientIdentifier, product,
                version, platform, platformVersion,
                device, model, deviceVendor,
                deviceName, marketplace, playQueueId,
