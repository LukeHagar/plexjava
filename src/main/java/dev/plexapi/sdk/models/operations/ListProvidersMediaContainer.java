...
public class ListProvidersMediaContainer {
     ...
     * A unique identifier for the provider, e.g. `com.plexapp.plugins.library`.
     */
    public ListProvidersMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
     ...
     * A unique identifier for the provider, e.g. `com.plexapp.plugins.library`.
     */
    public ListProvidersMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * The offset of where this container page starts among the total objects available. Also provided in the `X-Plex-Container-Start` header.
     */
    public ListProvidersMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * The offset of where this container page starts among the total objects available. Also provided in the `X-Plex-Container-Start` header.
     */
    public ListProvidersMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public ListProvidersMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public ListProvidersMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public ListProvidersMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public ListProvidersMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }

    public ListProvidersMediaContainer withAllowCameraUpload(boolean allowCameraUpload) {
        Utils.checkNotNull(allowCameraUpload, "allowCameraUpload");
    ...
    public ListProvidersMediaContainer withAllowCameraUpload(Optional<Boolean> allowCameraUpload) {
        Utils.checkNotNull(allowCameraUpload, "allowCameraUpload");
        this.allowCameraUpload = allowCameraUpload;
        return this;
    }

    public ListProvidersMediaContainer withAllowChannelAccess(boolean allowChannelAccess) {
        Utils.checkNotNull(allowChannelAccess, "allowChannelAccess");
    ...
    public ListProvidersMediaContainer withAllowChannelAccess(Optional<Boolean> allowChannelAccess) {
        Utils.checkNotNull(allowChannelAccess, "allowChannelAccess");
        this.allowChannelAccess = allowChannelAccess;
        return this;
    }

    public ListProvidersMediaContainer withAllowMediaDeletion(boolean allowMediaDeletion) {
        Utils.checkNotNull(allowMediaDeletion, "allowMediaDeletion");
    ...
    public ListProvidersMediaContainer withAllowMediaDeletion(Optional<Boolean> allowMediaDeletion) {
        Utils.checkNotNull(allowMediaDeletion, "allowMediaDeletion");
        this.allowMediaDeletion = allowMediaDeletion;
        return this;
    }

    public ListProvidersMediaContainer withAllowSharing(boolean allowSharing) {
        Utils.checkNotNull(allowSharing, "allowSharing");
    ...
    public ListProvidersMediaContainer withAllowSharing(Optional<Boolean> allowSharing) {
        Utils.checkNotNull(allowSharing, "allowSharing");
        this.allowSharing = allowSharing;
        return this;
    }

    public ListProvidersMediaContainer withAllowSync(boolean allowSync) {
        Utils.checkNotNull(allowSync, "allowSync");
    ...
    public ListProvidersMediaContainer withAllowSync(Optional<Boolean> allowSync) {
        Utils.checkNotNull(allowSync, "allowSync");
        this.allowSync = allowSync;
        return this;
    }

    public ListProvidersMediaContainer withAllowTuners(boolean allowTuners) {
        Utils.checkNotNull(allowTuners, "allowTuners");
    ...
    public ListProvidersMediaContainer withAllowTuners(Optional<Boolean> allowTuners) {
        Utils.checkNotNull(allowTuners, "allowTuners");
        this.allowTuners = allowTuners;
        return this;
    }

    public ListProvidersMediaContainer withBackgroundProcessing(boolean backgroundProcessing) {
        Utils.checkNotNull(backgroundProcessing, "backgroundProcessing");
    ...
    public ListProvidersMediaContainer withBackgroundProcessing(Optional<Boolean> backgroundProcessing) {
        Utils.checkNotNull(backgroundProcessing, "backgroundProcessing");
        this.backgroundProcessing = backgroundProcessing;
        return this;
    }

    public ListProvidersMediaContainer withCertificate(boolean certificate) {
        Utils.checkNotNull(certificate, "certificate");
    ...
    public ListProvidersMediaContainer withCertificate(Optional<Boolean> certificate) {
        Utils.checkNotNull(certificate, "certificate");
        this.certificate = certificate;
        return this;
    }

    public ListProvidersMediaContainer withCompanionProxy(boolean companionProxy) {
        Utils.checkNotNull(companionProxy, "companionProxy");
    ...
    public ListProvidersMediaContainer withCompanionProxy(Optional<Boolean> companionProxy) {
        Utils.checkNotNull(companionProxy, "companionProxy");
        this.companionProxy = companionProxy;
        return this;
    }

    public ListProvidersMediaContainer withCountryCode(String countryCode) {
        Utils.checkNotNull(countryCode, "countryCode");
    ...
    public ListProvidersMediaContainer withCountryCode(Optional<String> countryCode) {
        Utils.checkNotNull(countryCode, "countryCode");
        this.countryCode = countryCode;
        return this;
    }

    public ListProvidersMediaContainer withDiagnostics(String diagnostics) {
        Utils.checkNotNull(diagnostics, "diagnostics");
    ...
    public ListProvidersMediaContainer withDiagnostics(Optional<String> diagnostics) {
        Utils.checkNotNull(diagnostics, "diagnostics");
        this.diagnostics = diagnostics;
        return this;
    }

    public ListProvidersMediaContainer withEventStream(boolean eventStream) {
        Utils.checkNotNull(eventStream, "eventStream");
    ...
    public ListProvidersMediaContainer withEventStream(Optional<Boolean> eventStream) {
        Utils.checkNotNull(eventStream, "eventStream");
        this.eventStream = eventStream;
        return this;
    }

    public ListProvidersMediaContainer withFriendlyName(String friendlyName) {
        Utils.checkNotNull(friendlyName, "friendlyName");
    ...
    public ListProvidersMediaContainer withFriendlyName(Optional<String> friendlyName) {
        Utils.checkNotNull(friendlyName, "friendlyName");
        this.friendlyName = friendlyName;
        return this;
    }

    public ListProvidersMediaContainer withHubSearch(boolean hubSearch) {
        Utils.checkNotNull(hubSearch, "hubSearch");
    ...
    public ListProvidersMediaContainer withHubSearch(Optional<Boolean> hubSearch) {
        Utils.checkNotNull(hubSearch, "hubSearch");
        this.hubSearch = hubSearch;
        return this;
    }

    public ListProvidersMediaContainer withItemClusters(boolean itemClusters) {
        Utils.checkNotNull(itemClusters, "itemClusters");
    ...
    public ListProvidersMediaContainer withItemClusters(Optional<Boolean> itemClusters) {
        Utils.checkNotNull(itemClusters, "itemClusters");
        this.itemClusters = itemClusters;
        return this;
    }

    public ListProvidersMediaContainer withLivetv(long livetv) {
        Utils.checkNotNull(livetv, "livetv");
    ...
    public ListProvidersMediaContainer withLivetv(Optional<Long> livetv) {
        Utils.checkNotNull(livetv, "livetv");
        this.livetv = livetv;
        return this;
    }

    public ListProvidersMediaContainer withMachineIdentifier(Object machineIdentifier) {
        Utils.checkNotNull(machineIdentifier, "machineIdentifier");
    ...
    public ListProvidersMediaContainer withMachineIdentifier(Optional<? extends Object> machineIdentifier) {
        Utils.checkNotNull(machineIdentifier, "machineIdentifier");
        this.machineIdentifier = machineIdentifier;
        return this;
    }

    public ListProvidersMediaContainer withMediaProviders(boolean mediaProviders) {
        Utils.checkNotNull(mediaProviders, "mediaProviders");
    ...
    public ListProvidersMediaContainer withMediaProviders(Optional<Boolean> mediaProviders) {
        Utils.checkNotNull(mediaProviders, "mediaProviders");
        this.mediaProviders = mediaProviders;
        return this;
    }

    public ListProvidersMediaContainer withMultiuser(boolean multiuser) {
        Utils.checkNotNull(multiuser, "multiuser");
    ...
    public ListProvidersMediaContainer withMultiuser(Optional<Boolean> multiuser) {
        Utils.checkNotNull(multiuser, "multiuser");
        this.multiuser = multiuser;
        return this;
    }

    public ListProvidersMediaContainer withMusicAnalysis(long musicAnalysis) {
        Utils.checkNotNull(musicAnalysis, "musicAnalysis");
    ...
    public ListProvidersMediaContainer withMusicAnalysis(Optional<Long> musicAnalysis) {
        Utils.checkNotNull(musicAnalysis, "musicAnalysis");
        this.musicAnalysis = musicAnalysis;
        return this;
    }

    public ListProvidersMediaContainer withMyPlex(boolean myPlex) {
        Utils.checkNotNull(myPlex, "myPlex");
    ...
    public ListProvidersMediaContainer withMyPlex(Optional<Boolean> myPlex) {
        Utils.checkNotNull(myPlex, "myPlex");
        this.myPlex = myPlex;
        return this;
    }

    public ListProvidersMediaContainer withMyPlexMappingState(Object myPlexMappingState) {
        Utils.checkNotNull(myPlexMappingState, "myPlexMappingState");
    ...
    public ListProvidersMediaContainer withMyPlexMappingState(Optional<? extends Object> myPlexMappingState) {
        Utils.checkNotNull(myPlexMappingState, "myPlexMappingState");
        this.myPlexMappingState = myPlexMappingState;
        return this;
    }

    public ListProvidersMediaContainer withMyPlexSigninState(Object myPlexSigninState) {
        Utils.checkNotNull(myPlexSigninState, "myPlexSigninState");
    ...
    public ListProvidersMediaContainer withMyPlexSigninState(Optional<? extends Object> myPlexSigninState) {
        Utils.checkNotNull(myPlexSigninState, "myPlexSigninState");
        this.myPlexSigninState = myPlexSigninState;
        return this;
    }

    public ListProvidersMediaContainer withMyPlexSubscription(boolean myPlexSubscription) {
        Utils.checkNotNull(myPlexSubscription, "myPlexSubscription");
    ...
    public ListProvidersMediaContainer withMyPlexSubscription(Optional<Boolean> myPlexSubscription) {
        Utils.checkNotNull(myPlexSubscription, "myPlexSubscription");
        this.myPlexSubscription = myPlexSubscription;
        return this;
    }

    public ListProvidersMediaContainer withMyPlexUsername(String myPlexUsername) {
        Utils.checkNotNull(myPlexUsername, "myPlexUsername");
    ...
    public ListProvidersMediaContainer withMyPlexUsername(Optional<String> myPlexUsername) {
        Utils.checkNotNull(myPlexUsername, "myPlexUsername");
        this.myPlexUsername = myPlexUsername;
        return this;
    }

    public ListProvidersMediaContainer withOfflineTranscode(Object offlineTranscode) {
        Utils.checkNotNull(offlineTranscode, "offlineTranscode");
    ...
    public ListProvidersMediaContainer withOfflineTranscode(Optional<? extends Object> offlineTranscode) {
        Utils.checkNotNull(offlineTranscode, "offlineTranscode");
        this.offlineTranscode = offlineTranscode;
        return this;
    }
     ...
     * A comma-separated list of features which are enabled for the server owner
     */
    public ListProvidersMediaContainer withOwnerFeatures(String ownerFeatures) {
        Utils.checkNotNull(ownerFeatures, "ownerFeatures");
     ...
     * A comma-separated list of features which are enabled for the server owner
     */
    public ListProvidersMediaContainer withOwnerFeatures(Optional<String> ownerFeatures) {
        Utils.checkNotNull(ownerFeatures, "ownerFeatures");
        this.ownerFeatures = ownerFeatures;
        return this;
    }

    public ListProvidersMediaContainer withPlatform(String platform) {
        Utils.checkNotNull(platform, "platform");
    ...
    public ListProvidersMediaContainer withPlatform(Optional<String> platform) {
        Utils.checkNotNull(platform, "platform");
        this.platform = platform;
        return this;
    }

    public ListProvidersMediaContainer withPlatformVersion(String platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
    ...
    public ListProvidersMediaContainer withPlatformVersion(Optional<String> platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
        this.platformVersion = platformVersion;
        return this;
    }

    public ListProvidersMediaContainer withPluginHost(boolean pluginHost) {
        Utils.checkNotNull(pluginHost, "pluginHost");
    ...
    public ListProvidersMediaContainer withPluginHost(Optional<Boolean> pluginHost) {
        Utils.checkNotNull(pluginHost, "pluginHost");
        this.pluginHost = pluginHost;
        return this;
    }

    public ListProvidersMediaContainer withPushNotifications(boolean pushNotifications) {
        Utils.checkNotNull(pushNotifications, "pushNotifications");
    ...
    public ListProvidersMediaContainer withPushNotifications(Optional<Boolean> pushNotifications) {
        Utils.checkNotNull(pushNotifications, "pushNotifications");
        this.pushNotifications = pushNotifications;
        return this;
    }

    public ListProvidersMediaContainer withReadOnlyLibraries(boolean readOnlyLibraries) {
        Utils.checkNotNull(readOnlyLibraries, "readOnlyLibraries");
    ...
    public ListProvidersMediaContainer withReadOnlyLibraries(Optional<Boolean> readOnlyLibraries) {
        Utils.checkNotNull(readOnlyLibraries, "readOnlyLibraries");
        this.readOnlyLibraries = readOnlyLibraries;
        return this;
    }

    public ListProvidersMediaContainer withStreamingBrainABRVersion(long streamingBrainABRVersion) {
        Utils.checkNotNull(streamingBrainABRVersion, "streamingBrainABRVersion");
    ...
    public ListProvidersMediaContainer withStreamingBrainABRVersion(Optional<Long> streamingBrainABRVersion) {
        Utils.checkNotNull(streamingBrainABRVersion, "streamingBrainABRVersion");
        this.streamingBrainABRVersion = streamingBrainABRVersion;
        return this;
    }

    public ListProvidersMediaContainer withStreamingBrainVersion(long streamingBrainVersion) {
        Utils.checkNotNull(streamingBrainVersion, "streamingBrainVersion");
    ...
    public ListProvidersMediaContainer withStreamingBrainVersion(Optional<Long> streamingBrainVersion) {
        Utils.checkNotNull(streamingBrainVersion, "streamingBrainVersion");
        this.streamingBrainVersion = streamingBrainVersion;
        return this;
    }

    public ListProvidersMediaContainer withSync(boolean sync) {
        Utils.checkNotNull(sync, "sync");
    ...
    public ListProvidersMediaContainer withSync(Optional<Boolean> sync) {
        Utils.checkNotNull(sync, "sync");
        this.sync = sync;
        return this;
    }

    public ListProvidersMediaContainer withTranscoderActiveVideoSessions(long transcoderActiveVideoSessions) {
        Utils.checkNotNull(transcoderActiveVideoSessions, "transcoderActiveVideoSessions");
    ...
    public ListProvidersMediaContainer withTranscoderActiveVideoSessions(Optional<Long> transcoderActiveVideoSessions) {
        Utils.checkNotNull(transcoderActiveVideoSessions, "transcoderActiveVideoSessions");
        this.transcoderActiveVideoSessions = transcoderActiveVideoSessions;
        return this;
    }

    public ListProvidersMediaContainer withTranscoderAudio(boolean transcoderAudio) {
        Utils.checkNotNull(transcoderAudio, "transcoderAudio");
    ...
    public ListProvidersMediaContainer withTranscoderAudio(Optional<Boolean> transcoderAudio) {
        Utils.checkNotNull(transcoderAudio, "transcoderAudio");
        this.transcoderAudio = transcoderAudio;
        return this;
    }

    public ListProvidersMediaContainer withTranscoderLyrics(boolean transcoderLyrics) {
        Utils.checkNotNull(transcoderLyrics, "transcoderLyrics");
    ...
    public ListProvidersMediaContainer withTranscoderLyrics(Optional<Boolean> transcoderLyrics) {
        Utils.checkNotNull(transcoderLyrics, "transcoderLyrics");
        this.transcoderLyrics = transcoderLyrics;
        return this;
    }

    public ListProvidersMediaContainer withTranscoderPhoto(boolean transcoderPhoto) {
        Utils.checkNotNull(transcoderPhoto, "transcoderPhoto");
    ...
    public ListProvidersMediaContainer withTranscoderPhoto(Optional<Boolean> transcoderPhoto) {
        Utils.checkNotNull(transcoderPhoto, "transcoderPhoto");
        this.transcoderPhoto = transcoderPhoto;
        return this;
    }

    public ListProvidersMediaContainer withTranscoderSubtitles(boolean transcoderSubtitles) {
        Utils.checkNotNull(transcoderSubtitles, "transcoderSubtitles");
    ...
    public ListProvidersMediaContainer withTranscoderSubtitles(Optional<Boolean> transcoderSubtitles) {
        Utils.checkNotNull(transcoderSubtitles, "transcoderSubtitles");
        this.transcoderSubtitles = transcoderSubtitles;
        return this;
    }

    public ListProvidersMediaContainer withTranscoderVideo(boolean transcoderVideo) {
        Utils.checkNotNull(transcoderVideo, "transcoderVideo");
    ...
    public ListProvidersMediaContainer withTranscoderVideo(Optional<Boolean> transcoderVideo) {
        Utils.checkNotNull(transcoderVideo, "transcoderVideo");
        this.transcoderVideo = transcoderVideo;
        return this;
    }
     ...
     * The suggested video quality bitrates to present to the user
     */
    public ListProvidersMediaContainer withTranscoderVideoBitrates(Object transcoderVideoBitrates) {
        Utils.checkNotNull(transcoderVideoBitrates, "transcoderVideoBitrates");
     ...
     * The suggested video quality bitrates to present to the user
     */
    public ListProvidersMediaContainer withTranscoderVideoBitrates(Optional<? extends Object> transcoderVideoBitrates) {
        Utils.checkNotNull(transcoderVideoBitrates, "transcoderVideoBitrates");
        this.transcoderVideoBitrates = transcoderVideoBitrates;
        return this;
    }

    public ListProvidersMediaContainer withTranscoderVideoQualities(String transcoderVideoQualities) {
        Utils.checkNotNull(transcoderVideoQualities, "transcoderVideoQualities");
    ...
    public ListProvidersMediaContainer withTranscoderVideoQualities(Optional<String> transcoderVideoQualities) {
        Utils.checkNotNull(transcoderVideoQualities, "transcoderVideoQualities");
        this.transcoderVideoQualities = transcoderVideoQualities;
        return this;
    }
     ...
     * The suggested video resolutions to the above quality bitrates
     */
    public ListProvidersMediaContainer withTranscoderVideoResolutions(Object transcoderVideoResolutions) {
        Utils.checkNotNull(transcoderVideoResolutions, "transcoderVideoResolutions");
     ...
     * The suggested video resolutions to the above quality bitrates
     */
    public ListProvidersMediaContainer withTranscoderVideoResolutions(Optional<? extends Object> transcoderVideoResolutions) {
        Utils.checkNotNull(transcoderVideoResolutions, "transcoderVideoResolutions");
        this.transcoderVideoResolutions = transcoderVideoResolutions;
        return this;
    }

    public ListProvidersMediaContainer withUpdatedAt(long updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
    ...
    public ListProvidersMediaContainer withUpdatedAt(Optional<Long> updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
        this.updatedAt = updatedAt;
        return this;
    }

    public ListProvidersMediaContainer withUpdater(boolean updater) {
        Utils.checkNotNull(updater, "updater");
    ...
    public ListProvidersMediaContainer withUpdater(Optional<Boolean> updater) {
        Utils.checkNotNull(updater, "updater");
        this.updater = updater;
        return this;
    }

    public ListProvidersMediaContainer withVersion(String version) {
        Utils.checkNotNull(version, "version");
    ...
    public ListProvidersMediaContainer withVersion(Optional<String> version) {
        Utils.checkNotNull(version, "version");
        this.version = version;
        return this;
    }

    public ListProvidersMediaContainer withVoiceSearch(boolean voiceSearch) {
        Utils.checkNotNull(voiceSearch, "voiceSearch");
    ...
    public ListProvidersMediaContainer withVoiceSearch(Optional<Boolean> voiceSearch) {
        Utils.checkNotNull(voiceSearch, "voiceSearch");
        this.voiceSearch = voiceSearch;
        return this;
    }

    public ListProvidersMediaContainer withFeature(List<Feature> feature) {
        Utils.checkNotNull(feature, "feature");
    ...
    public ListProvidersMediaContainer withFeature(Optional<? extends List<Feature>> feature) {
        Utils.checkNotNull(feature, "feature");
        this.feature = feature;
        return this;
    }
     ...
     * - `stream`: The provider allows streaming media directly from the provider (e.g. for Vimeo). - `download`: The provider allows downloading media for offline storage, sync, etc. (e.g. Podcasts). - `livetv`: The provider provides live content which is only available on a schedule basis.
     */
    public ListProvidersMediaContainer withProtocols(String protocols) {
        Utils.checkNotNull(protocols, "protocols");
     ...
     * - `stream`: The provider allows streaming media directly from the provider (e.g. for Vimeo). - `download`: The provider allows downloading media for offline storage, sync, etc. (e.g. Podcasts). - `livetv`: The provider provides live content which is only available on a schedule basis.
     */
    public ListProvidersMediaContainer withProtocols(Optional<String> protocols) {
        Utils.checkNotNull(protocols, "protocols");
        this.protocols = protocols;
        return this;
    }
     ...
     * The title of the provider.
     */
    public ListProvidersMediaContainer withTitle(String title) {
        Utils.checkNotNull(title, "title");
     ...
     * The title of the provider.
     */
    public ListProvidersMediaContainer withTitle(Optional<String> title) {
        Utils.checkNotNull(title, "title");
        this.title = title;
        return this;
    }
     ...
     * This attribute contains a comma-separated list of the media types exposed by the provider (e.g. `video, audio`).
     */
    public ListProvidersMediaContainer withTypes(String types) {
        Utils.checkNotNull(types, "types");
     ...
     * This attribute contains a comma-separated list of the media types exposed by the provider (e.g. `video, audio`).
     */
    public ListProvidersMediaContainer withTypes(Optional<String> types) {
        Utils.checkNotNull(types, "types");
        this.types = types;
        return this;
    }
