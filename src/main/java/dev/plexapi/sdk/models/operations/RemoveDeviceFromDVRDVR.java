...
public class RemoveDeviceFromDVRDVR {
    ...
    public RemoveDeviceFromDVRDVR withDevice(List<Device> device) {
        Utils.checkNotNull(device, "device");
    ...
    public RemoveDeviceFromDVRDVR withDevice(Optional<? extends List<Device>> device) {
        Utils.checkNotNull(device, "device");
        this.device = device;
        return this;
    }

    public RemoveDeviceFromDVRDVR withKey(String key) {
        Utils.checkNotNull(key, "key");
    ...
    public RemoveDeviceFromDVRDVR withKey(Optional<String> key) {
        Utils.checkNotNull(key, "key");
        this.key = key;
        return this;
    }

    public RemoveDeviceFromDVRDVR withLanguage(String language) {
        Utils.checkNotNull(language, "language");
    ...
    public RemoveDeviceFromDVRDVR withLanguage(Optional<String> language) {
        Utils.checkNotNull(language, "language");
        this.language = language;
        return this;
    }

    public RemoveDeviceFromDVRDVR withLineup(String lineup) {
        Utils.checkNotNull(lineup, "lineup");
    ...
    public RemoveDeviceFromDVRDVR withLineup(Optional<String> lineup) {
        Utils.checkNotNull(lineup, "lineup");
        this.lineup = lineup;
        return this;
    }

    public RemoveDeviceFromDVRDVR withUuid(String uuid) {
        Utils.checkNotNull(uuid, "uuid");
    ...
    public RemoveDeviceFromDVRDVR withUuid(Optional<String> uuid) {
        Utils.checkNotNull(uuid, "uuid");
        this.uuid = uuid;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RemoveDeviceFromDVRDVR other = (RemoveDeviceFromDVRDVR) o;
        return 
    ...
    public String toString() {
        return Utils.toString(RemoveDeviceFromDVRDVR.class,
                "device", device,
                "key", key,
                "language", language,
                "lineup", lineup,
    ...
    public final static class Builder {
        ...
        public RemoveDeviceFromDVRDVR build() {

            return new RemoveDeviceFromDVRDVR(
                device, key, language,
                lineup, uuid);
        }
