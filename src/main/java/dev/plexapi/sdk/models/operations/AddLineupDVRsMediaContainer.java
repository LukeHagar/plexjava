...
public class AddLineupDVRsMediaContainer {
    ...
    @JsonCreator
    public AddLineupDVRsMediaContainer(
    ...
    public AddLineupDVRsMediaContainer withIdentifier(String identifier) {
        Utils.checkNotNull(identifier, "identifier");
    ...
    public AddLineupDVRsMediaContainer withIdentifier(Optional<String> identifier) {
        Utils.checkNotNull(identifier, "identifier");
        this.identifier = identifier;
        return this;
    }
     ...
     * The offset of where this container page starts among the total objects available. Also provided in the `X-Plex-Container-Start` header.
     */
    public AddLineupDVRsMediaContainer withOffset(long offset) {
        Utils.checkNotNull(offset, "offset");
     ...
     * The offset of where this container page starts among the total objects available. Also provided in the `X-Plex-Container-Start` header.
     */
    public AddLineupDVRsMediaContainer withOffset(Optional<Long> offset) {
        Utils.checkNotNull(offset, "offset");
        this.offset = offset;
        return this;
    }

    public AddLineupDVRsMediaContainer withSize(long size) {
        Utils.checkNotNull(size, "size");
    ...
    public AddLineupDVRsMediaContainer withSize(Optional<Long> size) {
        Utils.checkNotNull(size, "size");
        this.size = size;
        return this;
    }
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public AddLineupDVRsMediaContainer withTotalSize(long totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
     ...
     * The total size of objects available. Also provided in the `X-Plex-Container-Total-Size` header.
     */
    public AddLineupDVRsMediaContainer withTotalSize(Optional<Long> totalSize) {
        Utils.checkNotNull(totalSize, "totalSize");
        this.totalSize = totalSize;
        return this;
    }
     ...
     * A status indicator. If present and non-zero, indicates an error
     */
    public AddLineupDVRsMediaContainer withStatus(long status) {
        Utils.checkNotNull(status, "status");
     ...
     * A status indicator. If present and non-zero, indicates an error
     */
    public AddLineupDVRsMediaContainer withStatus(Optional<Long> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AddLineupDVRsMediaContainer other = (AddLineupDVRsMediaContainer) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AddLineupDVRsMediaContainer.class,
    ...
    public final static class Builder {
        ...
        public AddLineupDVRsMediaContainer build() {

            return new AddLineupDVRsMediaContainer(
                identifier, offset, size,
                totalSize, status);
        }
