...
public class GetLineupRequest {
    ...
    public GetLineupRequest(
        ...
        Utils.checkNotNull(lineupGroup, "lineupGroup");
    ...
    public GetLineupRequest(
        ...
        this(Optional.empty(), Optional.empty(), Optional.empty(),
            ...
            Optional.empty(), Optional.empty(), Optional.empty(),
            Optional.empty(), Optional.empty(), deviceQueryParameter,
            lineupGroup);
    }
     ...
     */
    @JsonIgnore
    public String deviceQueryParameter() {
        return deviceQueryParameter;
    }
     ...
     * Indicates the client accepts the indicated media types
     */
    public GetLineupRequest withAccepts(Accepts accepts) {
        Utils.checkNotNull(accepts, "accepts");
     ...
     * Indicates the client accepts the indicated media types
     */
    public GetLineupRequest withAccepts(Optional<? extends Accepts> accepts) {
        Utils.checkNotNull(accepts, "accepts");
        this.accepts = accepts;
        return this;
    }
     ...
     * An opaque identifier unique to the client
     */
    public GetLineupRequest withClientIdentifier(String clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
     ...
     * An opaque identifier unique to the client
     */
    public GetLineupRequest withClientIdentifier(Optional<String> clientIdentifier) {
        Utils.checkNotNull(clientIdentifier, "clientIdentifier");
        this.clientIdentifier = clientIdentifier;
        return this;
    }
     ...
     * The name of the client product
     */
    public GetLineupRequest withProduct(String product) {
        Utils.checkNotNull(product, "product");
     ...
     * The name of the client product
     */
    public GetLineupRequest withProduct(Optional<String> product) {
        Utils.checkNotNull(product, "product");
        this.product = product;
        return this;
    }
     ...
     * The version of the client application
     */
    public GetLineupRequest withVersion(String version) {
        Utils.checkNotNull(version, "version");
     ...
     * The version of the client application
     */
    public GetLineupRequest withVersion(Optional<String> version) {
        Utils.checkNotNull(version, "version");
        this.version = version;
        return this;
    }
     ...
     * The platform of the client
     */
    public GetLineupRequest withPlatform(String platform) {
        Utils.checkNotNull(platform, "platform");
     ...
     * The platform of the client
     */
    public GetLineupRequest withPlatform(Optional<String> platform) {
        Utils.checkNotNull(platform, "platform");
        this.platform = platform;
        return this;
    }
     ...
     * The version of the platform
     */
    public GetLineupRequest withPlatformVersion(String platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
     ...
     * The version of the platform
     */
    public GetLineupRequest withPlatformVersion(Optional<String> platformVersion) {
        Utils.checkNotNull(platformVersion, "platformVersion");
        this.platformVersion = platformVersion;
        return this;
    }
     ...
     * A relatively friendly name for the client device
     */
    public GetLineupRequest withDevice(String device) {
        Utils.checkNotNull(device, "device");
     ...
     * A relatively friendly name for the client device
     */
    public GetLineupRequest withDevice(Optional<String> device) {
        Utils.checkNotNull(device, "device");
        this.device = device;
        return this;
    }
     ...
     * A potentially less friendly identifier for the device model
     */
    public GetLineupRequest withModel(String model) {
        Utils.checkNotNull(model, "model");
     ...
     * A potentially less friendly identifier for the device model
     */
    public GetLineupRequest withModel(Optional<String> model) {
        Utils.checkNotNull(model, "model");
        this.model = model;
        return this;
    }
     ...
     * The device vendor
     */
    public GetLineupRequest withDeviceVendor(String deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
     ...
     * The device vendor
     */
    public GetLineupRequest withDeviceVendor(Optional<String> deviceVendor) {
        Utils.checkNotNull(deviceVendor, "deviceVendor");
        this.deviceVendor = deviceVendor;
        return this;
    }
     ...
     * A friendly name for the client
     */
    public GetLineupRequest withDeviceName(String deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
     ...
     * A friendly name for the client
     */
    public GetLineupRequest withDeviceName(Optional<String> deviceName) {
        Utils.checkNotNull(deviceName, "deviceName");
        this.deviceName = deviceName;
        return this;
    }
     ...
     * The marketplace on which the client application is distributed
     */
    public GetLineupRequest withMarketplace(String marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
     ...
     * The marketplace on which the client application is distributed
     */
    public GetLineupRequest withMarketplace(Optional<String> marketplace) {
        Utils.checkNotNull(marketplace, "marketplace");
        this.marketplace = marketplace;
        return this;
    }
     ...
     * The URI describing the device
     */
    public GetLineupRequest withDeviceQueryParameter(String deviceQueryParameter) {
        Utils.checkNotNull(deviceQueryParameter, "deviceQueryParameter");
        this.deviceQueryParameter = deviceQueryParameter;
        return this;
    }
     ...
     * The URI describing the lineupGroup
     */
    public GetLineupRequest withLineupGroup(String lineupGroup) {
        Utils.checkNotNull(lineupGroup, "lineupGroup");
        this.lineupGroup = lineupGroup;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetLineupRequest other = (GetLineupRequest) o;
        return 
            ...
            Utils.enhancedDeepEquals(this.lineupGroup, other.lineupGroup);
    }
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            deviceName, marketplace, deviceQueryParameter,
            lineupGroup);
    }
    
    @Override
    public String toString() {
        return Utils.toString(GetLineupRequest.class,
                "accepts", accepts,
    ...
    public final static class Builder {
         ...
         * The URI describing the device
         */
        public Builder deviceQueryParameter(String deviceQueryParameter) {
            Utils.checkNotNull(deviceQueryParameter, "deviceQueryParameter");
            this.deviceQueryParameter = deviceQueryParameter;
            return this;
        }
         ...
         * The URI describing the lineupGroup
         */
        public Builder lineupGroup(String lineupGroup) {
            Utils.checkNotNull(lineupGroup, "lineupGroup");
            this.lineupGroup = lineupGroup;
            return this;
        }

        public GetLineupRequest build() {
            if (accepts == null) {
                accepts = _SINGLETON_VALUE_Accepts.value();
            }

            return new GetLineupRequest(
                accepts, clientIdentifier, product,
                version, platform, platformVersion,
                device, model, deviceVendor,
                deviceName, marketplace, deviceQueryParameter,
