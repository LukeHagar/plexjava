...
public class GetDVRDVR {
    ...
    public GetDVRDVR withDevice(List<Device> device) {
        Utils.checkNotNull(device, "device");
    ...
    public GetDVRDVR withDevice(Optional<? extends List<Device>> device) {
        Utils.checkNotNull(device, "device");
        this.device = device;
        return this;
    }

    public GetDVRDVR withKey(String key) {
        Utils.checkNotNull(key, "key");
    ...
    public GetDVRDVR withKey(Optional<String> key) {
        Utils.checkNotNull(key, "key");
        this.key = key;
        return this;
    }

    public GetDVRDVR withLanguage(String language) {
        Utils.checkNotNull(language, "language");
    ...
    public GetDVRDVR withLanguage(Optional<String> language) {
        Utils.checkNotNull(language, "language");
        this.language = language;
        return this;
    }

    public GetDVRDVR withLineup(String lineup) {
        Utils.checkNotNull(lineup, "lineup");
    ...
    public GetDVRDVR withLineup(Optional<String> lineup) {
        Utils.checkNotNull(lineup, "lineup");
        this.lineup = lineup;
        return this;
    }

    public GetDVRDVR withUuid(String uuid) {
        Utils.checkNotNull(uuid, "uuid");
    ...
    public GetDVRDVR withUuid(Optional<String> uuid) {
        Utils.checkNotNull(uuid, "uuid");
        this.uuid = uuid;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(GetDVRDVR.class,
                "device", device,
                "key", key,
                "language", language,
                "lineup", lineup,
    ...
    public final static class Builder {
        ...
        public GetDVRDVR build() {

            return new GetDVRDVR(
                device, key, language,
                lineup, uuid);
        }
