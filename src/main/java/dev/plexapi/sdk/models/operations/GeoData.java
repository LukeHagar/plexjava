...
public class GeoData {
     ...
     * The ISO 3166-1 alpha-2 code of the country.
     */
    public GeoData withCode(String code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
     ...
     * The continent code where the country is located.
     */
    public GeoData withContinentCode(String continentCode) {
        Utils.checkNotNull(continentCode, "continentCode");
        this.continentCode = continentCode;
        return this;
    }
     ...
     * The official name of the country.
     */
    public GeoData withCountry(String country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
     ...
     * The name of the city.
     */
    public GeoData withCity(String city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }
     ...
     * Indicates if the country is a member of the European Union.
     */
    public GeoData withEuropeanUnionMember(boolean europeanUnionMember) {
        Utils.checkNotNull(europeanUnionMember, "europeanUnionMember");
     ...
     * Indicates if the country is a member of the European Union.
     */
    public GeoData withEuropeanUnionMember(Optional<Boolean> europeanUnionMember) {
        Utils.checkNotNull(europeanUnionMember, "europeanUnionMember");
        this.europeanUnionMember = europeanUnionMember;
        return this;
    }
     ...
     * The time zone of the country.
     */
    public GeoData withTimeZone(String timeZone) {
        Utils.checkNotNull(timeZone, "timeZone");
        this.timeZone = timeZone;
        return this;
    }
     ...
     * Indicates if the country has privacy restrictions.
     */
    public GeoData withInPrivacyRestrictedCountry(boolean inPrivacyRestrictedCountry) {
        Utils.checkNotNull(inPrivacyRestrictedCountry, "inPrivacyRestrictedCountry");
     ...
     * Indicates if the country has privacy restrictions.
     */
    public GeoData withInPrivacyRestrictedCountry(Optional<Boolean> inPrivacyRestrictedCountry) {
        Utils.checkNotNull(inPrivacyRestrictedCountry, "inPrivacyRestrictedCountry");
        this.inPrivacyRestrictedCountry = inPrivacyRestrictedCountry;
        return this;
    }
     ...
     * Indicates if the region has privacy restrictions.
     */
    public GeoData withInPrivacyRestrictedRegion(Optional<Boolean> inPrivacyRestrictedRegion) {
        Utils.checkNotNull(inPrivacyRestrictedRegion, "inPrivacyRestrictedRegion");
        this.inPrivacyRestrictedRegion = inPrivacyRestrictedRegion;
        return this;
    }
     ...
     * The name of the primary administrative subdivision.
     */
    public GeoData withSubdivisions(String subdivisions) {
        Utils.checkNotNull(subdivisions, "subdivisions");
        this.subdivisions = subdivisions;
        return this;
    }
     ...
     * The geographical coordinates (latitude, longitude) of the location.
     */
    public GeoData withCoordinates(String coordinates) {
        Utils.checkNotNull(coordinates, "coordinates");
        this.coordinates = coordinates;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(GeoData.class,
                "code", code,
